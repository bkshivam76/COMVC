...
namespace ConnectOneMVC.Areas.Profile.Models
{
    ...
    {
        public string DI_PARTY_ID { get; set; }
        public string ITEM_NAME { get; set; }

        public string DI_ITEM_ID { get; set; }
        public string PARTY_NAME { get; set; }
        public string DI_AGAINST_INSURANCE { get; set; }
        public string DI_DEP_DATE { get; set; }
        public decimal DI_DEP_PERIOD { get; set; }
        public decimal DI_INT_RATE { get; set; }
        public DateTime? DI_MAT_DATE { get; set; }
        public string DI_OTHER_DETAIL { get; set; }
