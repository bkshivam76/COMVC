...
Namespace QAService
    ...
    Partial Public Class WebService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.Common_Lib.My.MySettings.Default.ConnectOne_D0000_QAService_WebService
        ...
        Public Function GetData(ByVal Query As String) As System.Data.DataTable
            Dim results() As Object = Me.Invoke("GetData", New Object() {Query})
            Return CType(results(0),System.Data.DataTable)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GetDataAsync(ByVal Query As String)
            Me.GetDataAsync(Query, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GetDataAsync(ByVal Query As String, ByVal userState As Object)
            If (Me.GetDataOperationCompleted Is Nothing) Then
                Me.GetDataOperationCompleted = AddressOf Me.OnGetDataOperationCompleted
            End If
            Me.InvokeAsync("GetData", New Object() {Query}, Me.GetDataOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        Public Overloads Sub ExecuteQueryAsync(ByVal Query As String)
            Me.ExecuteQueryAsync(Query, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub ExecuteQueryAsync(ByVal Query As String, ByVal userState As Object)
