...
Public Class Frm_Purpose_Report
...
#Region "Start--> Form Events"
    ...
    Private Sub Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'xPleaseWait.Show("Purpose Report" & vbNewLine & vbNewLine & "L o a d i n g . . . !")
        Base = MainBase
...
#Region "Start--> Procedures"
    ...
    Public Sub Grid_Display()
        Dim Table As DataTable '= Base._Reports_Common_DBOps.GetPurposeReport(Common_Lib.RealTimeService.ClientScreen.Report_Purpose)
        ...
        Select Case Action
            ...
            Case "PRINT-LIST"
                If CType(Me.PivotGridControl1.DataSource, DataTable).Rows.Count > 0 Then
                    'Base.Show_ListPreview(PivotGridControl1, Me.Text, Me, True, Printing.PaperKind.A4, Me.Text, "", "", True)
                End If
                Me.PivotGridControl1.Focus()
            Case "CLOSE"
                Me.Close()
