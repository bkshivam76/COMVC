...
#Region "Start--> Procedures"
    ...
    Private Sub Set_Default()
        GridDefaultProperty()
        If TxnMID.Length > 0 Then Grid_Display()
        'xPleaseWait.Hide()
    End Sub
    ...
    Public Sub Grid_Display()
        ...
        Dim txn_Detail As DataTable = Base._Reports_Ledgers_DBOps.GetTransactionDetailsForLedger(TxnMID)
        If txn_Detail Is Nothing Then
        ...
        Me.GridControl1.DataSource = txn_Detail
        Me.GridView1.Columns("ORD").Visible = False
        Me.GridView1.Columns("Particulars").Width = 400
        'xPleaseWait.Hide()
    End Sub
