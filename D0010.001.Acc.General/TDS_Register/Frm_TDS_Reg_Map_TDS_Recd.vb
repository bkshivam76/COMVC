...
Public Class Frm_TDS_Reg_Map_TDS_Recd
...
#Region "Start--> Button Events"
    ...
    Private Sub BUT_ACCEPT_Click(sender As Object, e As EventArgs) Handles BUT_ACCEPT.Click
        If Val(lblNetBalance.Text) < 0 Then
            DevExpress.XtraEditors.XtraMessageBox.Show("Total Mapped TDS deduction amount can not be greater than amount recd at HQ in voucher!!!", "Invalid Selection!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        End If
    ...
    Private Sub GridView1_ValidatingEditor(sender As Object, e As Controls.BaseContainerValidateEditorEventArgs) Handles GridView1.ValidatingEditor
        ...
        If View.FocusedColumn.FieldName = "TDS_Send" Then
            If Not e.Value Is Nothing Then
                ...
                If Not IsDBNull(Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "TDS_Send")) Then
...
#Region "Start--> Procedures"
    ...
    Private Sub Set_Default()
        ...
        GridDefaultProperty()
        lblCenterName.Text = "Center:" & Cen_Name
        Grid_Display()
        SetBalances()
        'xPleaseWait.Hide()
    End Sub
    ...
    Public Sub Grid_Display()
        '  xPleaseWait.Show("TDS Deduction Entries for TDS received from Centers" & vbNewLine & vbNewLine & "L o a d i n g . . . !")
        RowFlag1 = False
        Dim p1 As DataTable = Base._TDS_DBOps.GetTDS_Deducted_Not_Sent(xMID, Cen_ID)
