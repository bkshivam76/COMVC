...
Public Class Frm_Asset_Transfer_Pending
...
#Region "Start--> Procedures"
    ...
    Public Sub Grid_Display()
        ...
        Dim p1 As DataSet
        If Base._open_Cen_ID = 4216 Then
            p1 = Base._AssetTransfer_DBOps.GetUnMatchedList(0, Me.GLookUp_Cen_ListView.GetRowCellValue(Me.GLookUp_Cen_ListView.FocusedRowHandle, "TO_CEN_ID"))
        Else
            p1 = Base._AssetTransfer_DBOps.GetUnMatchedList(0, Nothing)
        End If
    ...
    Public _Date, _Item_ID, _CEN_ID, _ASSET_TYPE, _ASSET_REF_ID, _PUR_ID, _ID, _M_ID, _EDIT_DATE As String
    Public _ASSET_QTY, _ASSET_SALE_AMT As Double
        ...
        Select Case Action
            Case "ACCEPT"
                If Val(Me.GridView1.Tag) >= 0 Then
                    ...
                    _ASSET_TYPE = Me.GridView1.GetRowCellValue(Val(Me.GridView1.Tag), "Asset Type").ToString()
                    _ASSET_REF_ID = Me.GridView1.GetRowCellValue(Val(Me.GridView1.Tag), "ASSET_REF_ID").ToString()
                    _ASSET_QTY = Me.GridView1.GetRowCellValue(Val(Me.GridView1.Tag), "Qty / Weight").ToString()
                    _ASSET_SALE_AMT = Me.GridView1.GetRowCellValue(Val(Me.GridView1.Tag), "Amount").ToString()
                    ...
                    _EDIT_DATE = Me.GridView1.GetRowCellValue(Val(Me.GridView1.Tag), "REC_EDIT_ON").ToString() 'ADDED FOR MULTIUSER TASK
    ...
    Public Sub FillCentres()
        Dim Centres As DataTable = Base._AssetTransfer_DBOps.GetToCenterList("", "", "", "")
