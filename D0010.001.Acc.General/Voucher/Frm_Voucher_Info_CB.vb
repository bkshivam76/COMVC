...
Public Class Frm_Voucher_Info_CB
...
#Region "Start--> Default Variables"
    ...
    'Dim xMessageWindow As Common_Lib.Prompt_Window = New Common_Lib.Prompt_Window
    Public Sub New()
...
#Region "Start--> Procedures"
    ...
    Public Sub Grid_Display()
        ...
        Dim Cash_Bal As DataTable
        'Get last unaudited Year Closing Cash Balance 
        Cash_Bal = Base._Voucher_DBOps.GetCashBalanceSummary(xFr_Date, xTo_Date, Base._open_Year_Sdt, Base._open_Cen_ID, Base._open_Year_ID, Base._open_Ins_ID)
        If Cash_Bal Is Nothing Then
            DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            'Base.ShowMessagebox("Error!!", Common_Lib.Messages.SomeError, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
            Me.Close() : Exit Sub
        End If
        ...
        If Bank_Bal.Rows.Count > 0 Then Me.iTR_REC_BANK.Visible = False : Me.iTR_PAY_BANK.Visible = False : _colWidth -= _colSetWidth : But_HideBank.Text = "Hide Bank" Else But_HideBank.Text = "Show Bank"
        ...
        If Bank_Bal.Rows.Count > 0 Then
            For Each XROW In Bank_Bal.Rows
                ...
                Select Case _bankCnt
                    Case 1
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal01 = XROW("OPENING") Else Open_Bank_Bal01 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal01 = XROW("CLOSING") Else Close_Bank_Bal01 = 0

                        REC_BANK01.FieldName = "REC_BANK01" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK01.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK01.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK01.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK01.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK01.Visible = True : REC_BANK01.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK01}) : Me.Band_Receipt.Columns.Add(REC_BANK01)
                        _online_BANK_COL_TR_REC += " Sum(  CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK01, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK01, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK01.FieldName = "PAY_BANK01" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK01.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK01.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK01.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK01.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK01.Visible = True : PAY_BANK01.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK01}) : Me.Band_Payment.Columns.Add(PAY_BANK01)
                        _online_BANK_COL_TR_PAY += " Sum(  CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK01, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK01, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                    Case 2
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal02 = XROW("OPENING") Else Open_Bank_Bal02 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal02 = XROW("CLOSING") Else Close_Bank_Bal02 = 0

                        REC_BANK02.FieldName = "REC_BANK02" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK02.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK02.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK02.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK02.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK02.Visible = True : REC_BANK02.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK02}) : Me.Band_Receipt.Columns.Add(REC_BANK02)
                        _online_BANK_COL_TR_REC += " Sum(  CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK02, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK02, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK02.FieldName = "PAY_BANK02" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK02.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK02.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK02.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK02.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK02.Visible = True : PAY_BANK02.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK02}) : Me.Band_Payment.Columns.Add(PAY_BANK02)
                        _online_BANK_COL_TR_PAY += " Sum(  CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK02, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK02, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                    Case 3
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal03 = XROW("OPENING") Else Open_Bank_Bal03 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal03 = XROW("CLOSING") Else Close_Bank_Bal03 = 0

                        REC_BANK03.FieldName = "REC_BANK03" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK03.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK03.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK03.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK03.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK03.Visible = True : REC_BANK03.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK03}) : Me.Band_Receipt.Columns.Add(REC_BANK03)
                        _online_BANK_COL_TR_REC += " Sum( CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK03, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK03, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK03.FieldName = "PAY_BANK03" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK03.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK03.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK03.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK03.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK03.Visible = True : PAY_BANK03.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK03}) : Me.Band_Payment.Columns.Add(PAY_BANK03)
                        _online_BANK_COL_TR_PAY += " Sum(CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK03, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK03, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                    Case 4
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal04 = XROW("OPENING") Else Open_Bank_Bal04 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal04 = XROW("CLOSING") Else Close_Bank_Bal04 = 0

                        REC_BANK04.FieldName = "REC_BANK04" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK04.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK04.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK04.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK04.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK04.Visible = True : REC_BANK04.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK04}) : Me.Band_Receipt.Columns.Add(REC_BANK04)
                        _online_BANK_COL_TR_REC += " Sum( CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK04, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK04, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK04.FieldName = "PAY_BANK04" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK04.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK04.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK04.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK04.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK04.Visible = True : PAY_BANK04.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK04}) : Me.Band_Payment.Columns.Add(PAY_BANK04)
                        _online_BANK_COL_TR_PAY += " Sum( CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK04, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK04, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                    Case 5
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal05 = XROW("OPENING") Else Open_Bank_Bal05 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal05 = XROW("CLOSING") Else Close_Bank_Bal05 = 0

                        REC_BANK05.FieldName = "REC_BANK05" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK05.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK05.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK05.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK05.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK05.Visible = True : REC_BANK05.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK05}) : Me.Band_Receipt.Columns.Add(REC_BANK05)
                        _online_BANK_COL_TR_REC += " Sum( CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK05, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK05, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK05.FieldName = "PAY_BANK05" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK05.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK05.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK05.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK05.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK05.Visible = True : PAY_BANK05.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK05}) : Me.Band_Payment.Columns.Add(PAY_BANK05)
                        _online_BANK_COL_TR_PAY += " Sum( CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK05, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK05, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                    Case 6
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal06 = XROW("OPENING") Else Open_Bank_Bal06 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal06 = XROW("CLOSING") Else Close_Bank_Bal06 = 0

                        REC_BANK06.FieldName = "REC_BANK06" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK06.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK06.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK06.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK06.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK06.Visible = True : REC_BANK06.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK06}) : Me.Band_Receipt.Columns.Add(REC_BANK06)
                        _online_BANK_COL_TR_REC += " Sum( CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK06, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK06, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK06.FieldName = "PAY_BANK06" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK06.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK06.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK06.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK06.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK06.Visible = True : PAY_BANK06.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK06}) : Me.Band_Payment.Columns.Add(PAY_BANK06)
                        _online_BANK_COL_TR_PAY += " Sum( CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK06, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK06, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                    Case 7
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal07 = XROW("OPENING") Else Open_Bank_Bal07 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal07 = XROW("CLOSING") Else Close_Bank_Bal07 = 0

                        REC_BANK07.FieldName = "REC_BANK07" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK07.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK07.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK07.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK07.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK07.Visible = True : REC_BANK07.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK07}) : Me.Band_Receipt.Columns.Add(REC_BANK07)
                        _online_BANK_COL_TR_REC += " Sum(CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK07, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK07, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK07.FieldName = "PAY_BANK07" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK07.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK07.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK07.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK07.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK07.Visible = True : PAY_BANK07.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK07}) : Me.Band_Payment.Columns.Add(PAY_BANK07)
                        _online_BANK_COL_TR_PAY += " Sum(CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK07, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK07, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                    Case 8
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal08 = XROW("OPENING") Else Open_Bank_Bal08 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal08 = XROW("CLOSING") Else Close_Bank_Bal08 = 0

                        REC_BANK08.FieldName = "REC_BANK08" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK08.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK08.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK08.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK08.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK08.Visible = True : REC_BANK08.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK08}) : Me.Band_Receipt.Columns.Add(REC_BANK08)
                        _online_BANK_COL_TR_REC += " Sum(CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK08, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK08, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK08.FieldName = "PAY_BANK08" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK08.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK08.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK08.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK08.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK08.Visible = True : PAY_BANK08.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK08}) : Me.Band_Payment.Columns.Add(PAY_BANK08)
                        _online_BANK_COL_TR_PAY += " Sum( CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK08, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK08, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                    Case 9
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal09 = XROW("OPENING") Else Open_Bank_Bal09 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal09 = XROW("CLOSING") Else Close_Bank_Bal09 = 0

                        REC_BANK09.FieldName = "REC_BANK09" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK09.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK09.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK09.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK09.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK09.Visible = True : REC_BANK09.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK09}) : Me.Band_Receipt.Columns.Add(REC_BANK09)
                        _online_BANK_COL_TR_REC += " Sum( CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK09, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK09, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK09.FieldName = "PAY_BANK09" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK09.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK09.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK09.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK09.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK09.Visible = True : PAY_BANK09.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK09}) : Me.Band_Payment.Columns.Add(PAY_BANK09)
                        _online_BANK_COL_TR_PAY += " Sum( CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK09, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK09, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                    Case 10
                        If Not IsDBNull(XROW("OPENING")) Then Open_Bank_Bal10 = XROW("OPENING") Else Open_Bank_Bal10 = 0
                        If Not IsDBNull(XROW("CLOSING")) Then Close_Bank_Bal10 = XROW("CLOSING") Else Close_Bank_Bal10 = 0

                        REC_BANK10.FieldName = "REC_BANK10" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then REC_BANK10.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else REC_BANK10.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        REC_BANK10.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK10.CustomizationCaption = "Receipt Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : REC_BANK10.Visible = True : REC_BANK10.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {REC_BANK10}) : Me.Band_Receipt.Columns.Add(REC_BANK10)
                        _online_BANK_COL_TR_REC += " Sum( CASE WHEN TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as REC_BANK10, " : _online_BANK_COL_NB_REC += " NULL, "
                        _local__BANK_COL_TR_REC += " Sum( IIF(TR_DR_LED_ID='00079' and TR_SUB_DR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as REC_BANK10, " : _local__BANK_COL_NB_REC += " NULL, "

                        PAY_BANK10.FieldName = "PAY_BANK10" : If Len(XROW("BA_ACCOUNT_NO").ToString()) < 4 Then PAY_BANK10.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString Else PAY_BANK10.Caption = XROW("BI_SHORT_NAME") & " " & XROW("BA_ACCOUNT_NO").ToString.Substring(XROW("BA_ACCOUNT_NO").ToString.Length - 4, 4)
                        PAY_BANK10.ToolTip = "A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK10.CustomizationCaption = "Payment Bank: " & XROW("BI_SHORT_NAME") & ", A/c. No.: " & XROW("BA_ACCOUNT_NO") : PAY_BANK10.Visible = True : PAY_BANK10.Tag = "YES" : Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {PAY_BANK10}) : Me.Band_Payment.Columns.Add(PAY_BANK10)
                        _online_BANK_COL_TR_PAY += " Sum( CASE WHEN TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "' THEN TR_AMOUNT ELSE NULL END ) as PAY_BANK10, " : _online_BANK_COL_NB_PAY += " NULL, "
                        _local__BANK_COL_TR_PAY += " Sum( IIF(TR_CR_LED_ID='00079' and TR_SUB_CR_LED_ID='" & XROW("ID") & "',TR_AMOUNT,NULL) ) as PAY_BANK10, " : _local__BANK_COL_NB_PAY += " NULL, "
                        _colWidth += _colSetWidth
                End Select
                _bankCnt += 1
            Next
        ...
        '-------------------------------------------------------------------------------------------------------------------------------------
        'Get Ledger
        ' SHIFTED:Dim LED_Table As DataTable = Base._Voucher_DBOps.GetLedgers()
        ' SHIFTED:If LED_Table Is Nothing Then DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation) : Exit Sub
        '-------------------------------------------------------------------------------------------------------------------------------------
        'Get Item
        ' SHIFTED:Dim ITEM_Table As DataTable = Base._Voucher_DBOps.GetItemList("ID", "ITEM_NAME")
        ' SHIFTED:If ITEM_Table Is Nothing Then DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation) : Exit Sub
        '-------------------------------------------------------------------------------------------------------------------------------------
        'Get Address Book
        ' SHIFTED:Dim Unique_AB_Table As DataTable = Base._Voucher_DBOps.GetPastParties(xFr_Date, xTo_Date, False)
        ' SHIFTED:If Unique_AB_Table Is Nothing Then DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation) : Exit Sub
        ' SHIFTED:Dim AB_IDs As String = ""
        ' SHIFTED:For Each xRow As DataRow In Unique_AB_Table.Rows : AB_IDs += "'" & xRow("TR_AB_ID_1").ToString & "'," : Next
        ' SHIFTED:If AB_IDs.Trim.Length > 0 Then AB_IDs = IIf(AB_IDs.Trim.EndsWith(","), Mid(AB_IDs.Trim.ToString, 1, AB_IDs.Trim.Length - 1), AB_IDs.Trim.ToString)
        ' SHIFTED:If AB_IDs.Trim.Length = 0 Then AB_IDs = "''"
        '-------------------------------------------------------------------------------------------------------------------------------------
        'Get Party Name
        ' SHIFTED:Dim AB_TABLE As DataTable = Base._Voucher_DBOps.GetPastPartyDetails(AB_IDs)
        ' SHIFTED:If AB_TABLE Is Nothing Then DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation) : Exit Sub
        '-------------------------------------------------------------------------------------------------------------------------------------
        'Get Internal Transfer Centre List
        ' SHIFTED:Dim Trf_CEN_Table As DataTable = Base._Voucher_DBOps.GetPastParties(xFr_Date, xTo_Date, True)
        ' SHIFTED:If Trf_CEN_Table Is Nothing Then DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation) : Exit Sub
        ' SHIFTED:Dim CEN_REC_IDs As String = ""
        ' SHIFTED:For Each xRow As DataRow In Trf_CEN_Table.Rows : CEN_REC_IDs += "'" & xRow("TR_AB_ID_1").ToString & "'," : Next
        ' SHIFTED:If CEN_REC_IDs.Trim.Length > 0 Then CEN_REC_IDs = IIf(CEN_REC_IDs.Trim.EndsWith(","), Mid(CEN_REC_IDs.Trim.ToString, 1, CEN_REC_IDs.Trim.Length - 1), CEN_REC_IDs.Trim.ToString)
        ' SHIFTED:If CEN_REC_IDs.Trim.Length = 0 Then CEN_REC_IDs = "''"
        'Get Centre Name
        ' SHIFTED:Dim CEN_Name_Table As DataTable = Base._Voucher_DBOps.GetCenterList(CEN_REC_IDs)
        ' SHIFTED:If CEN_Name_Table Is Nothing Then DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation) : Exit Sub
        '-------------------------------------------------------------------------------------------------------------------------------------
        'Get Donation Status
        ' SHIFTED:Dim Donation_Status_Table As DataTable = Base._Voucher_DBOps.GetDonationStatus()
        ' SHIFTED:If Donation_Status_Table Is Nothing Then DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation) : Exit Sub
        ...
        'Transaction
        Dim TR_Table As DataTable = Base._Voucher_DBOps.GetList(xFr_Date, xTo_Date, _
                                                                _online_BANK_COL_TR_REC, _online_BANK_COL_NB_REC, _local__BANK_COL_TR_REC, _local__BANK_COL_NB_REC, _
                                                                _online_BANK_COL_TR_PAY, _online_BANK_COL_NB_PAY, _local__BANK_COL_TR_PAY, _local__BANK_COL_NB_PAY, Advanced_Filter_Category, Advanced_Filter_RefID)
        ...
        '---For Audit Menu--- ' check if removed correctly
        'Dim Remarks As Boolean
        'TR_Table.Columns.Add("Remarks", Remarks.GetType)
        'For Each XRow In TR_Table.Rows : XRow("Remarks") = IIf(XRow("RemarkCount") > 0, True, False) : Next
        '---End---
        ...
        'Item : SHIFTED
        ' SHIFTED:Voucher_DS.Tables.Add(ITEM_Table.Copy)
        ' SHIFTED:Dim Item_Relation As DataRelation = Voucher_DS.Relations.Add("Item", Voucher_DS.Tables(0).Columns("iTR_ITEM_ID"), Voucher_DS.Tables(1).Columns("ID"), False)
        'Ledger: SHIFTED
        ' SHIFTED:Voucher_DS.Tables.Add(LED_Table.Copy)
        ' SHIFTED:Dim LED_Relation As DataRelation = Voucher_DS.Relations.Add("Ledger", Voucher_DS.Tables("Transaction_Info").Columns("iLED_ID"), Voucher_DS.Tables("Acc_Ledger_Info").Columns("LED_ID"), False)
        'Party : SHIFTED
        ' SHIFTED:Voucher_DS.Tables.Add(AB_TABLE.Copy)
        ' SHIFTED:Dim AB_Relation As DataRelation = Voucher_DS.Relations.Add("AB", Voucher_DS.Tables("Transaction_Info").Columns("iTR_AB_ID_1"), Voucher_DS.Tables("ADDRESS_BOOK").Columns("C_ID"), False)
        'Centre : SHIFTED
        ' SHIFTED:Voucher_DS.Tables.Add(CEN_Name_Table.Copy)
        ' SHIFTED:Dim Centre_Relation As DataRelation = Voucher_DS.Relations.Add("CEN_NAME", Voucher_DS.Tables("Transaction_Info").Columns("iTR_AB_ID_1"), Voucher_DS.Tables("CENTRE_INFO").Columns("REC_ID"), False)
        'Bank
        ...
        'DONATION STATUS: SHIFTED
        ' SHIFTED:Voucher_DS.Tables.Add(Donation_Status_Table.Copy)
        ' SHIFTED:Dim Donation_Status As DataRelation = Voucher_DS.Relations.Add("Current Status", Voucher_DS.Tables("Transaction_Info").Columns("iREC_ID"), Voucher_DS.Tables("Donation_Status_Info").Columns("DS_TR_ID"), False)

        '-------------------(3) Update Relational Data--------------------------------------------------------------------------------------------
        For Each XROW In Voucher_DS.Tables(0).Rows
            'Item: SHIFTED
            ' SHIFTED:For Each Item_Row In XROW.GetChildRows(Item_Relation)
            ' SHIFTED:If XROW("iREC_ID") = "NOTE-BOOK" Then XROW("iTR_ITEM") = "Monthly " & Item_Row("ITEM_NAME") Else XROW("iTR_ITEM") = Item_Row("ITEM_NAME")
            ' SHIFTED:Next
            'Ledger: SHIFTED
            ' SHIFTED:For Each _Row In XROW.GetChildRows(LED_Relation)
            ' SHIFTED:XROW("iTR_HEAD") = _Row("LED_NAME")
            ' SHIFTED:Next
            'Party : SHIFTED
            ' SHIFTED:For Each _Row In XROW.GetChildRows(AB_Relation)
            ' SHIFTED:XROW("iTR_PARTY_1") = _Row("C_NAME")
            ' SHIFTED:Next
            'Centre: SHIFTED
            ' SHIFTED:For Each _Row In XROW.GetChildRows(Centre_Relation)
            ' SHIFTED:If XROW("iTR_CODE").ToString = 8 And XROW("iTR_PARTY_1").ToString.Length <= 0 Then XROW("iTR_PARTY_1") = StrConv(_Row("CEN_NAME"), vbProperCase) & " (" & _Row("CEN_BK_PAD_NO") & ")"
            ' SHIFTED:Next
            'Bank
            ...
            'Donation Status: SHIFTED
            ' SHIFTED:For Each _Row In XROW.GetChildRows(Donation_Status)
            ' SHIFTED:XROW("DON_STATUS") = _Row("DS_STATUS_MISC_ID")
            ' SHIFTED:Next
        Next
        ...
        If Month(xFr_Date) > 3 Then
            _Date_Serial = Month(xFr_Date) - 3 : _Date_Show = Year(Base._open_Year_Sdt) & "-" & Format(Month(xFr_Date), "00") & "-01"
        Else
            _Date_Serial = Month(xFr_Date) + 9 : _Date_Show = Year(Base._open_Year_Edt) & "-" & Format(Month(xFr_Date), "00") & "-01"
        End If
        Dim ROW As DataRow
        ...
        ROW("iTR_ROW_POS") = "A"
        ROW("iTR_VNO") = ""
        ROW("iTR_DATE") = Format(xFr_Date, Base._Date_Format_Current)
        ROW("iTR_REC_CASH") = Open_Cash_Bal
        ROW("iTR_REC_BANK") = Open_Bank_Bal
        ROW("iTR_ITEM") = "OPENING BALANCE"
        If REC_BANK01.TAG = "YES" Then ROW("REC_BANK01") = Open_Bank_Bal01
        If REC_BANK02.TAG = "YES" Then ROW("REC_BANK02") = Open_Bank_Bal02
        If REC_BANK03.TAG = "YES" Then ROW("REC_BANK03") = Open_Bank_Bal03
        If REC_BANK04.TAG = "YES" Then ROW("REC_BANK04") = Open_Bank_Bal04
        If REC_BANK05.TAG = "YES" Then ROW("REC_BANK05") = Open_Bank_Bal05
        If REC_BANK06.TAG = "YES" Then ROW("REC_BANK06") = Open_Bank_Bal06
        If REC_BANK07.TAG = "YES" Then ROW("REC_BANK07") = Open_Bank_Bal07
        If REC_BANK08.TAG = "YES" Then ROW("REC_BANK08") = Open_Bank_Bal08
        If REC_BANK09.TAG = "YES" Then ROW("REC_BANK09") = Open_Bank_Bal09
        If REC_BANK10.TAG = "YES" Then ROW("REC_BANK10") = Open_Bank_Bal10
        ...
        Me.GridControl1.DataSource = XTABLE : XTABLE.Dispose()
        '-------------------------------------------------------------------------------------------------------------------------------------
        ...
        If Base._IsVolumeCenter Then Me.BandedGridView1.Columns("iRef_no").Visible = True
        '-------------------------------------------------------------------------------------------------------------------------------------
        Show_Summary_Balances()
        '-------------------------------------------------------------------------------------------------------------------------------------
        ...
        End If
        If Not Base.CheckActionRights(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Common_Lib.Common.ClientAction.Lock_Unlock) And Not Base._open_Cen_ID = 4216 Then
        ...
        'Removed negative balance check to make speed better in cash book 
        'If Not Base._IsVolumeCenter Then Check_Negative_Balance()
        If Base._IsVolumeCenter Then But_HideBank_Click(Nothing, Nothing)
        xPleaseWait.Hide()
        ...
        If Negative_MsgStr.Trim.Length > 0 Then
            ...
            'Base.ShowMessagebox("Alert...", Negative_MsgStr, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
        End If
        ...
        Select Case Action
                    ...
                    If xfrm.DialogResult = DialogResult.OK Then
                        ...
                        If Voucher_Type = "DONATION - REGULAR" Then
                            ...
                            If Base._IsVolumeCenter And zfrm.DialogResult = Windows.Forms.DialogResult.OK Then
                                ...
                                : xfrm1.SelectedRefBankID = zfrm.GLookUp_RefBankList.Tag ': xfrm1.Selected_Deposit_Slip = Val(zfrm.Txt_Slip_No.Text)
                                xfrm1.ShowDialog()
                            End If
                            If Not zfrm Is Nothing Then zfrm.Dispose()
                        End If
                        ...
                        If Voucher_Type = "COLLECTION BOX" Then
                            ...
                            Else
                                ...
                                'Base.ShowMessagebox(Me.Text, "In " & Base._open_Ins_Name & vbNewLine & vbNewLine & "C o l l e c t i o n   B o x   E n t r y   N o t   A p p l i c a b l e . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            End If
                        End If
                        ...
                        If Voucher_Type = "RECEIPTS" Or Voucher_Type = "RECEIPTS - INSTITUTE" Then
                            ...
                            If zfrm.DialogResult = Windows.Forms.DialogResult.OK Then
                                xID = zfrm.xID.Text : xMID = zfrm.xMID.Text : Flag = True : xEntryDate = zfrm.Txt_V_Date.DateTime
                            End If
                            If Base._IsVolumeCenter And zfrm.DialogResult = Windows.Forms.DialogResult.OK Then
                                Dim xfrm1 As New Frm_Receipt_Options()
            ...
            Case "EDIT"
                If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.FocusedRowHandle) >= 0 Then
                    ...
                    If xTemp_ID = "OPENING BALANCE" Then
                        ...
                        'Base.ShowMessagebox("Information...", "Opening Balance cannot Edit / Delete from Voucher Entry...!" & vbNewLine & vbNewLine & "Note: Use Profile - Cash A/c. Information for CASH" & vbNewLine & Space(31) & "or Bank A/c. Information for BANK", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                        Exit Sub
                    End If
                    ...
                    'If xTemp_MID.Length > 0 Then
                    '    Dim xTDS_Map As DataTable = Base._Voucher_DBOps.GetTDS_Mapping(xTemp_MID)
                    '    If Not xTDS_Map Is Nothing Then
                    '        If xTDS_Map.Rows.Count > 0 Then
                    '            If xTDS_Map.Rows(0)("REF_TR_M_ID") = xTemp_MID Then
                    '                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry, Some TDS paid/received entry has been mapped with current TDS deduction entry...!" & vbNewLine & vbNewLine & "Please unmap that entry from TDS Register to edit this entry!!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    '                Exit Sub
                    '            Else
                    '                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry, Some TDS Deduction entry has been mapped with current TDS paid/received entry...!" & vbNewLine & vbNewLine & "Please unmap that entry from TDS Register to edit this entry!!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    '                Exit Sub
                    '            End If
                    '        End If
                    '    End If
                    ...
                    If xTemp_ID.Length > 0 Then
                        ...
                        If Entry_Found = False Then
                            ...
                            'Base.ShowMessagebox("Information...", "E n t r y   N o t   F o u n d  /  C h a n g e d   i n   b a c k g r o u n d  . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                        ...
                        If xRec_Status = Common_Lib.Common.Record_Status._Locked Then
                            ...
                            'Base.ShowMessagebox("Information...", "L o c k e d   E n t r y   c a n n o t   b e   E d i t e d /  D e l e t e d . . . !" & multiUserMsg & vbNewLine & vbNewLine & "Note:" & vbNewLine & "-------" & vbNewLine & "Drop your Request to Madhuban for Unlock this Entry," & vbNewLine & "If you really want to do some action...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            : Exit Sub
                        End If
                        ...
                        If Get_Closed_Bank_Status(xTemp_ID) Then
                            ...
                            'Base.ShowMessagebox("Information...", "E n t r y   c a n n o t   b e   E d i t e d /  D e l e t e d . . . !" & vbNewLine & vbNewLine & "In this entry, Used Bank A/c No.: " & Closed_Bank_Account_No & " was closed...!!!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Exit Sub
                        End If
                        ...
                        Select Case xVCode
                            ...
                            Case Common_Lib.Common.Voucher_Screen_Code.Donation_Regular
                                If (xTemp_D_Status <> "") AndAlso (xTemp_D_Status <> "42189485-9b6b-430a-8112-0e8882596f3c") AndAlso (xTemp_D_Status <> "3a99fadc-b336-480d-8116-fbd144bd7671") AndAlso (xTemp_D_Status <> "6a7c38ba-5779-4e21-acc7-c1829b7ec933") Then '--> "Donation Accepted" or "Receipt Request Rejected" andalso "Receipt Cancelled"
                                    ...
                                    'Base.ShowMessagebox("Information...", "D o n a t i o n   E n t r y   c a n n o t   b e   E d i t   /   D e l e t e . . . !" & vbNewLine & vbNewLine & "Note: Donation Status Changed, Check Donation Register..!!!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    Exit Sub
                                End If
                                If Base._DepositSlipsDBOps.GetSlipPrintStatus(xTemp_ID, Common_Lib.RealTimeService.ClientScreen.Accounts_Voucher_Donation) Then
                            ...
                            Case Common_Lib.Common.Voucher_Screen_Code.Payment
                                If (Base._Voucher_DBOps.CheckPaymentEditDetails(xTemp_MID) = True) Then
                            ...
                            Case Common_Lib.Common.Voucher_Screen_Code.Receipt
                                ...
                                If IsDate(FinalPayDate) Then
                                    If FinalPayDate <> DateTime.MinValue Then
                                        ...
                                        'Base.ShowMessagebox("Error!!", "Sorry! Deposit Referred in Current voucher has already been Finally Adjusted in Receipt Voucher Dated " & FinalPayDate.ToLongDateString(), Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        Exit Sub
                                    End If
                                End If
                                If Base._DepositSlipsDBOps.GetSlipPrintStatus(xTemp_MID, Common_Lib.RealTimeService.ClientScreen.Accounts_Voucher_Receipt) Then
                                    DevExpress.XtraEditors.XtraMessageBox.Show("Sorry! Deposit slip has already been printed for current transaction!!", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                    Exit Sub
                                End If
                            ...
                            Case Common_Lib.Common.Voucher_Screen_Code.Donation_Gift
                                Dim xTemp_WIP_Dependencies As DataTable = Base._WIPCretionVouchers.GetWIP_Dependencies(xTemp_MID) 'Get Dependent Entries on WIP creted by current Txn
                                If xTemp_WIP_Dependencies.Rows.Count > 0 Then
                                    DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Some Adjustment has been made against the WIP(" & xTemp_WIP_Dependencies.Rows(0)("WIP_REF").ToString() & ") raised in current transaction on " & xTemp_WIP_Dependencies.Rows(0)("Date").ToString() & " for Rs." & xTemp_WIP_Dependencies.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                    'Base.ShowMessagebox("Error!!", "Sorry ! Some Adjustment has been made against the WIP(" & xTemp_WIP_Dependencies.Rows(0)("WIP_REF").ToString() & ") raised in current transaction on " & xTemp_WIP_Dependencies.Rows(0)("Date").ToString() & " for Rs." & xTemp_WIP_Dependencies.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._699x260, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    Exit Sub
                                End If
                                        ...
                                        If xTemp_AssetID.Length > 0 Then
                                            ...
                                            If Not SaleRecord Is Nothing Then
                                                If SaleRecord.Rows.Count > 0 Then
                                                    ...
                                                    'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry contains a asset which was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._699x260, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                    Exit Sub
                                                End If
                                            End If
                                            ...
                                            If AssetTrfRecord.Rows.Count > 0 Then
                                                If AssetTrfRecord.Rows.Count > 0 Then
                                                    ...
                                                    'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry contains a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._699x260, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                    Exit Sub
                                                End If
                                            End If
                                            ...
                                            If Not ReferenceRecord Is Nothing Then
                                                If ReferenceRecord.Rows.Count > 0 Then
                                                    ...
                                                    'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry contains a asset which was referred in a Dependent Entry Dated " & Convert.ToDateTime(ReferenceRecord.Rows(0)("TR_DATE")).ToLongDateString() & " of Rs." & ReferenceRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._699x260, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                    Exit Sub
                                                End If
                                            End If
                                        End If
                                            ...
                                            If RefID.Length > 0 Then
                                                ...
                                                If Not SaleRecord Is Nothing Then
                                                    If SaleRecord.Rows.Count > 0 Then
                                                        ...
                                                        'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry refers a asset which was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._699x260, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                        Exit Sub
                                                    End If
                                                End If
                                                ...
                                                If AssetTrfRecord.Rows.Count > 0 Then
                                                    If AssetTrfRecord.Rows.Count > 0 Then
                                                        ...
                                                        'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry refers a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._699x260, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                        Exit Sub
                                                    End If
                                                End If
                                            End If
                                    ...
                                    If d1.Rows.Count > 0 Then
                                        ...
                                        If Not IsDBNull(d1.Rows(0)("TR_TRF_CROSS_REF_ID")) Then
                                            If d1.Rows(0)("TR_TRF_CROSS_REF_ID").Length > 0 Then
                                                ...
                                                'Base.ShowMessagebox("Information...", "M a t c h e d   I n t e r n a l   T r a n s f e r   c a n n o t   b e   E d i t e d . . . !" & multiUserMsg, Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        ...
                                        Else
                                            If isRecChanged Then '#5518 fix
                                                ...
                                                'Base.ShowMessagebox("Information...", "Record has already been unmatched in the background", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Grid_Display()
                                                Exit Sub
                                            End If
                                        End If
                                ...
                                Select Case xItemID
                                    Case "f6e4da62-821f-4961-9f93-f5177fca2a77" 'FD New
                                        If IsDate(IsClosed) Then
                                            DevExpress.XtraEditors.XtraMessageBox.Show("F D  A l r e a d y  C l o s e d / R e n ew e d / T r a n s f e r r e d. . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                            'Base.ShowMessagebox("Information...", "F D  A l r e a d y  C l o s e d / R e n ew e d . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            Exit Sub
                                        ElseIf Has_Int_TDS > 0 Then
                                            ...
                                            'Base.ShowMessagebox("Information...", "I n t e r e s t / T D S  a l r e a d y  e n t e r e d  a g a i n s t  F D!" & vbNewLine & vbNewLine & "Please remove such transactions to edit/delete this FD.", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            Exit Sub
                                        Else
                                    ...
                                    Case "1ed5cbe4-c8aa-4583-af44-eba3db08e117", "65730a27-e365-4195-853e-2f59225fe8f4" 'FD Close - Interest, 65730a27-e365-4195-853e-2f59225fe8f4
                                        If IsRenew > 0 Then
                                            If IsDate(IsClosed) Then
                                                DevExpress.XtraEditors.XtraMessageBox.Show("F D   A l r e a d y   C l o s e d   /   R e n e w e d / T r a n s f e r r e d . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                'Base.ShowMessagebox("Information...", "F D   A l r e a d y   C l o s e d   /   R e n ew e d . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Exit Sub
                                            ElseIf Has_Int_TDS > 0 Then
                                                DevExpress.XtraEditors.XtraMessageBox.Show("I n t e r e s t   /   T D S   a l r e a d y   e n t e r e d   a g a i n s t   F D . . . !" & vbNewLine & vbNewLine & "Please remove such transactions to edit/delete this FD.", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            ...
                            Case Common_Lib.Common.Voucher_Screen_Code.Sale_Asset
                                ...
                                If xTemp_AdvID.Length > 0 Then
                                    ...
                                    If Not txnReferAdvance Is Nothing Then
                                        If txnReferAdvance.Rows.Count > 0 Then
                                            ...
                                            'Base.ShowMessagebox(Me.Text, "Sorry ! Some adjustment / refund has been made against the advance raised in current transaction on " & Convert.ToDateTime(txnReferAdvance.Rows(0)("TR_DATE")).ToLongDateString() & " for Rs." & txnReferAdvance.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            Exit Sub
                                        End If
                                    End If
                                    ...
                                    If Not txnReferAdvance Is Nothing Then
                                        If txnReferAdvance.Rows.Count > 0 Then
                                            DevExpress.XtraEditors.XtraMessageBox.Show("S o r r y!   A d v a n c e   c r e a t e d   b y   c u r r e n t   e n t r y   i s   u s e d   i n   s o m e   o t h e r   e n t r y. . . !" & vbNewLine & vbNewLine & "Please delete that dependency to delete this entry.", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                            'Base.ShowMessagebox(Me.Text, "S o r r y!   A d v a n c e   c r e a t e d   b y   c u r r e n t   j o u r n a l   e n t r y   i s   u s e d   i n   s o m e   o t h e r   e n t r y. . . !" & vbNewLine & vbNewLine & "Please delete that dependency to delete this entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            Exit Sub
                                        End If
                                    End If
                                End If
                                ...
                                If DateDiff(DateInterval.Second, MaxEditOn, Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_EDIT_ON")) < 0 Then 'bug #5608 point2 fix
                                    ...
                                    If Adj_NextYear > 0 Then
                                        ...
                                        'Base.ShowMessagebox("Error!!", "Sorry! Some adjustments have already been made on this asset" & vbNewLine & vbNewLine & " Please delete those entries for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        Exit Sub
                                    End If
                                Else
                            ...
                            Case Common_Lib.Common.Voucher_Screen_Code.Membership
                                ...
                                If GetValue.ToString.ToUpper = "DISCONTINUED" Then
                                    DevExpress.XtraEditors.XtraMessageBox.Show("D i s c o n t i u n e d   M e m b e r   E n t r y   c a n n o t   b e   E d i t e d  /  D e l e t e d . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                    'Base.ShowMessagebox("Information...", "D i s c o n t i u n e d   M e m b e r   E n t r y   c a n n o t   b e   E d i t e d  /  D e l e t e d . . . !", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    : Exit Sub
                                End If
                                ...
                                If T1.Rows.Count > 0 Then
                                    ...
                                    Next
                                    If TrFound Then
                                        DevExpress.XtraEditors.XtraMessageBox.Show("S o m e   a n o t h e r   E n t r y   a v a i l a b l e   a f t e r   t h i s   E n t r y   o f   s a m e   M e m b e r . . . . !", "Cannot Edited / Delete...", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                        'Base.ShowMessagebox("Cannot Edit / Delete...", "S o m e   a n o t h e r   E n t r y   a v a i l a b l e   a f t e r   t h i s   E n t r y   o f   s a m e   M e m b e r . . . . !", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        : Exit Sub
                                    End If
                                ...
                                If Base._Membership_Receipt_Register_DBOps.GetReceiptCount(xMaster_ID) > 0 Then
                                    ...
                                    'Base.ShowMessagebox(Me.Text, "M e m b e r s h i p   R e c e i p t   g e n e r a t e d   v o u c h e r   c a n n o t   b e   E d i t e d   /  D e l e t e d . . . !", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    Exit Sub
                                End If
                            ...
                            Case Common_Lib.Common.Voucher_Screen_Code.Membership_Renewal
                                ...
                                If GetValue.ToString.ToUpper = "DISCONTINUED" Then
                                    DevExpress.XtraEditors.XtraMessageBox.Show("D i s c o n t i u n e d   M e m b e r   E n t r y   c a n n o t   b e   E d i t e d  /  D e l e t e d . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                    'Base.ShowMessagebox("Information...", "D i s c o n t i u n e d   M e m b e r   E n t r y   c a n n o t   b e   E d i t e d  /  D e l e t e d . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    Exit Sub
                                End If
                            ...
                            Case Common_Lib.Common.Voucher_Screen_Code.Journal
                                ...
                                If xTemp_WIP_Dependencies.Rows.Count > 0 Then
                                    DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Some Adjustment has been made against the WIP(" & xTemp_WIP_Dependencies.Rows(0)("WIP_REF").ToString() & ") raised in current transaction on " & xTemp_WIP_Dependencies.Rows(0)("Date").ToString() & " for Rs." & xTemp_WIP_Dependencies.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                    'Base.ShowMessagebox("Error!!", "Sorry ! Some Adjustment has been made against the WIP(" & xTemp_WIP_Dependencies.Rows(0)("WIP_REF").ToString() & ") raised in current transaction on " & xTemp_WIP_Dependencies.Rows(0)("Date").ToString() & " for Rs." & xTemp_WIP_Dependencies.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    Exit Sub
                                End If
                                    ...
                                    If xTemp_AssetProfile.ToUpper <> "NOT APPLICABLE" Then ' Leaving Constuction Items
                                        ...
                                        Select Case xTemp_AssetProfile ' Get Asset RecID from Particular Table 
                                            ...
                                            Case "LAND & BUILDING"
                                                xTemp_AssetID = Base._Voucher_DBOps.GetAssetRecID(Common_Lib.RealTimeService.Tables.LAND_BUILDING_INFO, xTemp_MID)
                                            Case "WIP"
                                                xTemp_AssetID = Base._Voucher_DBOps.GetAssetRecID(Common_Lib.RealTimeService.Tables.WIP_INFO, xTemp_MID)
                                        End Select
                                        If xTemp_AssetID.Length > 0 Then
                                            Dim SaleRecord As DataTable = Base._Voucher_DBOps.GetSaleReferenceRecord(xTemp_AssetID)
                                            If Not SaleRecord Is Nothing Then
                                                If SaleRecord.Rows.Count > 0 Then
                                                    DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Selected Entry contains a asset which was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                    'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry contains a asset which was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                    Exit Sub
                                                End If
                                            End If
                                            ...
                                            If AssetTrfRecord.Rows.Count > 0 Then
                                                If AssetTrfRecord.Rows.Count > 0 Then
                                                    DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Selected Entry contains a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                    'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry contains a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                    Exit Sub
                                                End If
                                            End If
                                            'Gets any Txn where Current Asset is referenced, mostly in case of L&B
                                            ...
                                            If Not ReferenceRecord Is Nothing Then
                                                If ReferenceRecord.Rows.Count > 0 Then
                                                    DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Selected Entry contains a asset which was referred in a Dependent Entry Dated " & Convert.ToDateTime(ReferenceRecord.Rows(0)("TR_DATE")).ToLongDateString() & " of Rs." & ReferenceRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                    'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry contains a asset which was referred in a Dependent Entry Dated " & Convert.ToDateTime(ReferenceRecord.Rows(0)("TR_DATE")).ToLongDateString() & " of Rs." & ReferenceRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                    Exit Sub
                                                End If
                                            End If
                                        End If
                                        'Else 'Non Profile Entries 
                                        '    Dim _RefID As String = Base._Voucher_DBOps.GetReferenceRecordID(xTemp_MID)
                                        ...
                                        '                End If
                                        '            End If
                                        '            Dim AssetTrfRecord As DataTable = Base._AssetTransfer_DBOps.GetAssetTransfers(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, "", _RefID) 'checks if the referred property for constt items has been sold 'Bug #5339 fix
                                        '            If AssetTrfRecord.Rows.Count > 0 Then
                                        '                If AssetTrfRecord.Rows.Count > 0 Then
                                        '                    DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Selected Entry refers a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                        '                    Exit Sub
                                ...
                                If RefId.Length > 0 Then
                                    ...
                                    If UseCount > 0 Then
                                        ...
                                        'Base.ShowMessagebox(Me.Text, "S o r r y!  A d v a n c e   c r e a t e d   b y   c u r r e n t   j o u r n a l   e n t r y   i s   u s e d   i n   s o m e   o t h e r   e n t r y. . . !" & vbNewLine & vbNewLine & "Please delete that dependency to edit this entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        Exit Sub
                                    End If
                                    Dim param As Common_Lib.RealTimeService.Parameter_GetJornalEntryAdjustments = New Common_Lib.RealTimeService.Parameter_GetJornalEntryAdjustments()
                                ...
                                If RefId.Length > 0 Then
                                    ...
                                    If UseCount > 0 Then
                                        ...
                                        'Base.ShowMessagebox(Me.Text, "S o r r y!  d e p o s i t   c r e a t e d   b y   c u r r e n t   j o u r n a l   e n t r y   i s   u s e d   i n   s o m e   o t h e r   e n t r y. . . !" & vbNewLine & vbNewLine & "Please delete that dependency to edit this entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        Exit Sub
                                    End If
                                    Dim param As Common_Lib.RealTimeService.Parameter_GetJornalEntryAdjustments = New Common_Lib.RealTimeService.Parameter_GetJornalEntryAdjustments()
                                    param.CrossRefId = RefId
                                ...
                                If RefId.Length > 0 Then
                                    ...
                                    If UseCount > 0 Then
                                        ...
                                        'Base.ShowMessagebox(Me.Text, "S o r r y!  l i a b i l i t y   c r e a t e d   b y   c u r r e n t   j o u r n a l   e n t r y   i s   u s e d   i n   s o m e   o t h e r   e n t r y. . . !" & vbNewLine & vbNewLine & "Please delete that dependency to edit this entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        Exit Sub
                                    End If
                                    Dim param As Common_Lib.RealTimeService.Parameter_GetJornalEntryAdjustments = New Common_Lib.RealTimeService.Parameter_GetJornalEntryAdjustments()
                                    param.CrossRefId = RefId
                                ...
                                For Each Row As DataRow In Base._Voucher_DBOps.GetRefRecordIDS(xTemp_MID).Rows
                                    If Row("ITEM_PROFILE") = "GOLD" Or Row("ITEM_PROFILE") = "SILVER" Or Row("ITEM_PROFILE") = "OTHER ASSETS" Or Row("ITEM_PROFILE") = "LIVESTOCK" Or Row("ITEM_PROFILE") = "LAND & BUILDING" Or Row("ITEM_PROFILE") = "VEHICLES" Or Row("ITEM_VOUCHER_TYPE").ToString.ToUpper = "LAND & BUILDING" Then
                                                ...
                                                If RefId.Length > 0 Then
                                                    ...
                                                    If DateDiff(DateInterval.Second, MaxEditOn, Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_EDIT_ON")) < 0 Then 'bug #5608 point2 fix
                                                        ...
                                                        If Not SaleRecord Is Nothing Then
                                                            If SaleRecord.Rows.Count > 0 Then
                                                                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Selected Entry refers a asset which was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                                'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry refers a asset which was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                                Exit Sub
                                                            End If
                                                        End If
                                                        ...
                                                        If AssetTrfRecord.Rows.Count > 0 Then
                                                            If AssetTrfRecord.Rows.Count > 0 Then
                                                                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Selected Entry refers a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                                'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry refers a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                                Exit Sub
                                                            End If
                                                        End If
                                                        '#5589 fix
                                                        ...
                                                        If Adj_NextYear > 0 Then
                                                            ...
                                                            'Base.ShowMessagebox("Error!!", "Sorry! Selected Entry contains an asset against which adjustments have been made in current / next year" & vbNewLine & vbNewLine & " Please delete those entries for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                            Exit Sub
                                                        End If
                                                        'End If
                                                    Else
                                                        If Not xfrm.Info_MaxEditedOn.ContainsKey(RefId) Then xfrm.Info_MaxEditedOn.Add(RefId, MaxEditOn) 'Bug #5695 fix
                                                    End If
                                                End If
                                            End If
                                        End If
                            ...
                            Case Common_Lib.Common.Voucher_Screen_Code.Asset_Transfer
                                    ...
                                    If Rec.Rows.Count > 0 Then
                                        ...
                                        If Not IsDBNull(Rec.Rows(0)("TR_TRF_CROSS_REF_ID")) Then
                                            If Rec.Rows(0)("TR_TRF_CROSS_REF_ID").Length > 0 Then
                                                ...
                                                'Base.ShowMessagebox("Information...", "M a t c h e d   A s s e t   T r a n s f e r   c a n n o t   b e   E d i t e d. . . !" & multiUserMsg, Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                If isRecChanged Then Grid_Display()
                                                Exit Sub
                                            End If
                                        Else
                                ...
                                If (Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle - _RowHandle, "iTR_TYPE").ToString()) = "CREDIT" Then
                                    ...
                                    'Base.ShowMessagebox("Information...", "A s s e t   T r a n s f e r   F r o m   E n t r y   c a n n o t   b e   E d i t e d. . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    Exit Sub
                                End If
                                ...
                                If (Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle - _RowHandle, "iTR_TYPE").ToString()) = "DEBIT" Then
                                    ...
                                    If DateDiff(DateInterval.Second, MaxEditOn, Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_EDIT_ON")) < 0 Then 'bug #5610 point2 fix
                                        ...
                                        If Adj_NextYear > 0 Then
                                            DevExpress.XtraEditors.XtraMessageBox.Show("Sorry! Some adjustments have already been made on this asset" & vbNewLine & vbNewLine & " Please delete those entries for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                            'Base.ShowMessagebox("Error!!", "Sorry! Some adjustments have already been made on this asset" & vbNewLine & vbNewLine & " Please delete those entries for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            Exit Sub
                                        End If
                                    Else
                                        xfrm.Info_MaxEditedOn = MaxEditOn
                                ...
                                If xfrm.DialogResult = Windows.Forms.DialogResult.Cancel And isRecChanged Then Grid_Display() '#5518 fix
                                If Not xfrm Is Nothing Then xfrm.Dispose()
                            Case Common_Lib.Common.Voucher_Screen_Code.WIP_Finalization
                                Dim xTemp_AssetID As String = ""
                                ...
                                If xTemp_AssetID.Length > 0 Then
                                    ...
                                    If Not SaleRecord Is Nothing Then
                                        If SaleRecord.Rows.Count > 0 Then
                                            DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! The asset created by current voucher was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                            'Base.ShowMessagebox("Error!!", "Sorry ! The asset created by current voucher was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            Exit Sub
                                        End If
                                    End If
                                    ...
                                    If AssetTrfRecord.Rows.Count > 0 Then
                                        If AssetTrfRecord.Rows.Count > 0 Then
                                            DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! The asset created by current voucher was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                            'Base.ShowMessagebox("Error!!", "Sorry ! The asset created by current voucher was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            Exit Sub
                                        End If
                                    End If
                                    'Gets any Txn where Current Asset is referenced
                                    Dim ReferenceRecord As DataTable = Base._Voucher_DBOps.GetReferenceTxnRecord_Exclude_MID(xTemp_AssetID, xTemp_MID)
                                    If Not ReferenceRecord Is Nothing Then
                                        If ReferenceRecord.Rows.Count > 0 Then
                                            DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! The asset created by current voucher was referred in a Dependent Entry Dated " & Convert.ToDateTime(ReferenceRecord.Rows(0)("TR_DATE")).ToLongDateString() & " of Rs." & ReferenceRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                            'Base.ShowMessagebox("Error!!", "Sorry ! The asset created by current voucher was referred in a Dependent Entry Dated " & Convert.ToDateTime(ReferenceRecord.Rows(0)("TR_DATE")).ToLongDateString() & " of Rs." & ReferenceRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            Exit Sub
                                        End If
                                    End If
                                End If

                                Dim xfrm As New Frm_Voucher_Win_WIP_Finalization : xfrm.MainBase = Base : xfrm.Tag = Common_Lib.Common.Navigation_Mode._Edit : xfrm.xID.Text = xTemp_ID : xfrm.xMID.Text = xMaster_ID
                                For Each Row As DataRow In Base._Voucher_DBOps.GetRefRecordIDS(xTemp_MID).Rows
                                    If Row("ITEM_PROFILE") = "OTHER ASSETS" Then
                                        If Not IsDBNull(Row("TR_TRF_CROSS_REF_ID")) Then
                                            Dim MaxEditOn As DateTime = Base._AssetDBOps.Get_Asset_Ref_MaxEditOn(xCross_Ref_Id)
                                            If DateDiff(DateInterval.Second, MaxEditOn, Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_EDIT_ON")) < 0 Then 'bug #5608 point2 fix
                                                Dim SaleRecord As DataTable = Base._Voucher_DBOps.GetSaleReferenceRecord(xCross_Ref_Id)
                                                If Not SaleRecord Is Nothing Then
                                                    If SaleRecord.Rows.Count > 0 Then
                                                        DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! The asset created by current voucher was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                        'Base.ShowMessagebox("Error!!", "Sorry ! The asset created by current voucher was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                ...
                                                Dim AssetTrfRecord As DataTable = Base._AssetTransfer_DBOps.GetAssetTransfers(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Nothing, xCross_Ref_Id) 'Bug #5339 fix
                                                If AssetTrfRecord.Rows.Count > 0 Then
                                                    If AssetTrfRecord.Rows.Count > 0 Then
                                                        DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! The asset created by current voucher was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                        'Base.ShowMessagebox("Error!!", "Sorry ! The asset created by current voucher was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for editing this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
            ...
            Case "DELETE"
                    If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.FocusedRowHandle) >= 0 Then
                        ...
                        If xTemp_ID = "OPENING BALANCE" Then
                            DevExpress.XtraEditors.XtraMessageBox.Show("Opening Balance cannot Edit / Delete from Voucher Entry...!" & vbNewLine & vbNewLine & "Note: Use Profile - Cash A/c. Information for CASH" & vbNewLine & Space(31) & "or Bank A/c. Information for BANK", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                            'Base.ShowMessagebox("Information...", "Opening Balance cannot Edit / Delete from Voucher Entry...!" & vbNewLine & vbNewLine & "Note: Use Profile - Cash A/c. Information for CASH" & vbNewLine & Space(31) & "or Bank A/c. Information for BANK", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Exit Sub
                        End If
                        If xTemp_ID = "NOTE-BOOK" Then
                            Dim xFrm As New Frm_NoteBook_Info : xFrm.MainBase = Base : xFrm.Text = "Note-Book Entry (" & Me.Text & ")"
                    ...
                    '        If xTDS_Map.Rows.Count > 0 Then
                    '            If xTDS_Map.Rows(0)("REF_TR_M_ID") = xTemp_MID Then
                    '                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry, Some TDS paid/received entry has been mapped with current TDS deduction entry...!" & vbNewLine & vbNewLine & "Please unmap that entry from TDS Register to delete this entry!!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    '                Exit Sub
                    '            Else
                    '                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry, Some TDS Deduction entry has been mapped with current TDS paid/received entry...!" & vbNewLine & vbNewLine & "Please unmap that entry from TDS Register to delete this entry!!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    '                Exit Sub
                    '            End If
                    '        End If
                    '    End If
                    'End If
                        ...
                        If xTemp_ID.Length > 0 Then
                            ...
                            If Entry_Found = False Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("E n t r y   N o t   F o u n d  /  C h a n g e d   i n   b a c k g r o u n d  . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox("Information...", "E n t r y   N o t   F o u n d  /  C h a n g e d   i n   b a c k g r o u n d  . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Grid_Display() : Exit Sub
                            End If
                            ...
                            If Get_Closed_Bank_Status(xTemp_ID) Then
                                ...
                                'Base.ShowMessagebox("Information...", "E n t r y   c a n n o t   b e   E d i t  /  D e l e t e . . . !" & vbNewLine & vbNewLine & "In this entry, Used Bank A/c No.: " & Closed_Bank_Account_No & " was closed...!!!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Exit Sub
                            End If
                            ...
                            Select Case xVCode
                                ...
                                Case Common_Lib.Common.Voucher_Screen_Code.Donation_Regular
                                    If (xTemp_D_Status <> "") AndAlso (xTemp_D_Status <> "42189485-9b6b-430a-8112-0e8882596f3c") AndAlso (xTemp_D_Status <> "3a99fadc-b336-480d-8116-fbd144bd7671") AndAlso (xTemp_D_Status <> "6a7c38ba-5779-4e21-acc7-c1829b7ec933") Then '--> "Donation Accepted" or "Receipt Request Rejected" andalso "Receipt Cancelled"
                                        ...
                                        'Base.ShowMessagebox("Information...", "D o n a t i o n   E n t r y   c a n n o t   b e   E d i t e d /   D e l e t e d . . . !" & vbNewLine & vbNewLine & "Note: Donation Status Changed, Check Donation Register..!!!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        Exit Sub
                                    End If
                                    If Base._DepositSlipsDBOps.GetSlipPrintStatus(xTemp_ID, Common_Lib.RealTimeService.ClientScreen.Accounts_Voucher_Donation) Then
                                        DevExpress.XtraEditors.XtraMessageBox.Show("Sorry! Deposit slip has already been printed for current transaction!!", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                ...
                                Case Common_Lib.Common.Voucher_Screen_Code.Payment
                                    ...
                                    If xTemp_WIP_Dependencies.Rows.Count > 0 Then
                                        DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Some Adjustment has been made against the WIP(" & xTemp_WIP_Dependencies.Rows(0)("WIP_REF").ToString() & ") raised in current transaction on " & xTemp_WIP_Dependencies.Rows(0)("Date").ToString() & " for Rs." & xTemp_WIP_Dependencies.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                        'Base.ShowMessagebox("Error!!", "Sorry ! Some Adjustment has been made against the WIP(" & xTemp_WIP_Dependencies.Rows(0)("WIP_REF").ToString() & ") raised in current transaction on " & xTemp_WIP_Dependencies.Rows(0)("Date").ToString() & " for Rs." & xTemp_WIP_Dependencies.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        Exit Sub
                                    End If
                                    ...
                                    If xTemp_LiabID.Length > 0 Then
                                        ...
                                        If Not txnReferLiab Is Nothing Then
                                            If txnReferLiab.Rows.Count > 0 Then
                                                ...
                                                'Base.ShowMessagebox("Error!!", "Sorry ! Some payment has been made against the liability raised in current transaction on " & Convert.ToDateTime(txnReferLiab.Rows(0)("TR_DATE")).ToLongDateString() & " for Rs." & txnReferLiab.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Exit Sub
                                            End If
                                        End If
                                    ...
                                    If xTemp_DepID.Length > 0 Then
                                        ...
                                        If Not txnReferDeposits Is Nothing Then
                                            If txnReferDeposits.Rows.Count > 0 Then
                                                ...
                                                'Base.ShowMessagebox("Error!!", "Sorry ! Some adjustment / refund has been made against the deposit raised in current transaction on " & Convert.ToDateTime(txnReferDeposits.Rows(0)("TR_DATE")).ToLongDateString() & " for Rs." & txnReferDeposits.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Exit Sub
                                            End If
                                        End If
                                            ...
                                            If xTemp_AssetID.Length > 0 Then
                                                ...
                                                If IsInsuaranceApplicable Then
                                                    If Base.IsInsuranceAudited() Then
                                                        DevExpress.XtraEditors.XtraMessageBox.Show("Sorry! Selected Entry contains insurance related assets which cannot be deleted after the completion of Insurance audit", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                                        'Base.ShowMessagebox("Information...", "Sorry! Selected Entry contains insurance related assets which cannot be deleted after the completion of Insurance audit", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                        : Exit Sub
                                                    End If
                                                End If
                                                ...
                                                If Not SaleRecord Is Nothing Then
                                                    If SaleRecord.Rows.Count > 0 Then
                                                        ...
                                                        'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry contains a asset which was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                        Exit Sub
                                                    End If
                                                End If
                                            Dim AssetTrfRecord As DataTable = Base._AssetTransfer_DBOps.GetAssetTransfers(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Nothing, xTemp_AssetID) 'Bug #5339 Fix
                                                If AssetTrfRecord.Rows.Count > 0 Then
                                                    If AssetTrfRecord.Rows.Count > 0 Then
                                                        ...
                                                        'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry refers a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                        Exit Sub
                                                    End If
                                                End If
                                                'Gets any Txn where Current Asset is referenced, mostly in case of L&B
                                                ...
                                                If Not ReferenceRecord Is Nothing Then
                                                    If ReferenceRecord.Rows.Count > 0 Then
                                                        ...
                                                        'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry contains a asset which was referred in a Dependent Entry Dated " & Convert.ToDateTime(ReferenceRecord.Rows(0)("TR_DATE")).ToLongDateString() & " of Rs." & ReferenceRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                        Exit Sub
                                                    End If
                                                End If
                                            End If
                                    Else 'Non Profile Entries 
                                        Dim PropertyID As Object = Base._Voucher_DBOps.GetReferenceRecordID(xTemp_MID)
                                        ...
                                        If Not SaleRecord Is Nothing Then
                                            If SaleRecord.Rows.Count > 0 Then
                                                ...
                                                'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry refers a asset which was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Exit Sub
                                            End If
                                        End If
                                        Dim AssetTrfRecord As DataTable = Base._AssetTransfer_DBOps.GetAssetTransfers(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Nothing, PropertyID) 'checks if the referred property for constt items has been transferred 'Bug #5339Fix
                                        If AssetTrfRecord.Rows.Count > 0 Then
                                            If AssetTrfRecord.Rows.Count > 0 Then
                                                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! Selected Entry refers a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry refers a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                        ...
                                        'Dim param As Common_Lib.RealTimeService.Parameter_GetJornalEntryAdjustments = New Common_Lib.RealTimeService.Parameter_GetJornalEntryAdjustments()
                                        'param.CrossRefId = PropertyID
                                        'param.SpecifiedEntryType = Common_Lib.RealTimeService.EntryType.Credit_Only
                                        'param.Excluded_Rec_M_ID = xTemp_MID
                                        'param.NextUnauditedYearID = Base._next_Unaudited_YearID
                                        'Dim txnReferProperty As DataTable = Base._Journal_voucher_DBOps.GetJornalEntryAdjustments(param, Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers)
                                        'If Not txnReferProperty Is Nothing Then
                                        '    If txnReferProperty.Rows.Count > 0 Then
                                        '        DevExpress.XtraEditors.XtraMessageBox.Show("S o r r y!   P r o p e r t y   r e f e r r e d   i n   c u r r e n t   v o u c h e r   i s   c r e d i t e d    i n   s o m e   o t h e r   J o u r n a l   e n t r y. . . !" & vbNewLine & vbNewLine & "Please delete that dependency to delete this entry.", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                        '        Exit Sub
                                        '    End If
                                        'End If
                                    End If
                                ...
                                For Each Row As DataRow In Base._Voucher_DBOps.GetRefRecordIDS(xTemp_MID).Rows
                                    If Row("ITEM_PROFILE") = "NOT APPLICABLE" Then
                                        If Not IsDBNull(Row("TR_TRF_CROSS_REF_ID")) Then 'Construction Entry
                                            Dim RefId As Object = Row("TR_TRF_CROSS_REF_ID")
                                            If Not RefId Is Nothing Then
                                                If RefId.Length > 0 Then
                                                    ...
                                                    '        DevExpress.XtraEditors.XtraMessageBox.Show("Sorry !  Deletion of Selected Payment Entry creates a Negative Closing Balance in Next Year for property with Original Value " & PROF_TABLE.Rows(0)("Org Value").ToString, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                    '        'Base.ShowMessagebox("Error!!", "Sorry !  Deletion of Selected Payment Entry creates a Negative Closing Balance in Next Year for " & Row("ITEM_PROFILE").ToString.ToLower & " with Original Value " & PROF_TABLE.Rows(0)("Org Value").ToString, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                    '        Exit Sub
                                                    '    End If
                                                    'End If

                                                    If PROF_TABLE.Rows(0)("Curr Value") < 0 Then
                                                        DevExpress.XtraEditors.XtraMessageBox.Show("Sorry !  Deletion of Selected Payment Entry creates a Negative Closing Balance in Current Year for property with Original Value " & PROF_TABLE.Rows(0)("Org Value").ToString, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                        'Base.ShowMessagebox("Error!!", "Sorry !  Deletion of Selected Payment Entry creates a Negative Closing Balance in Current Year for " & Row("ITEM_PROFILE").ToString.ToLower & " with Original Value " & PROF_TABLE.Rows(0)("Org Value").ToString, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                        Exit Sub
                                                    End If
                                                End If
                                            End If
                                    ...
                                    If Row("ITEM_PROFILE") = "WIP" Then
                                        ...
                                        End If
                                    End If
                                    'If Row("ITEM_VOUCHER_TYPE") = "Land & Building" Or Row("ITEM_VOUCHER_TYPE") = "Land & Building / Gift" Then
                                    '    If Not IsDBNull(Row("TR_TRF_CROSS_REF_ID")) Then
                                    '        Dim RefId As Object = Row("TR_TRF_CROSS_REF_ID")
                                    '        If Not RefId Is Nothing Then
                                    '            If RefId.Length > 0 Then
                                    '                Dim jrnl_Item As Frm_Voucher_Win_Journal_Item = New Frm_Voucher_Win_Journal_Item
                                    '                Dim PROF_TABLE As DataTable = jrnl_Item.GetReferenceData("", "", Row("TR_AB_ID_1"), xTemp_MID, Common_Lib.Common.Navigation_Mode._Delete, RefId)
                                    '                If Base._next_Unaudited_YearID <> Nothing Then
                                    '                    If PROF_TABLE.Rows(0)("Next Year Closing Value") < 0 Then
                                    '                        DevExpress.XtraEditors.XtraMessageBox.Show("Sorry !  Deletion of Selected Payment Entry creates a Negative Closing Balance in Next Year for Property with Original Value " & PROF_TABLE.Rows(0)("Org Value").ToString, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                    '                        'Base.ShowMessagebox("Error!!", "Sorry !  Deletion of Selected Payment Entry creates a Negative Closing Balance in Next Year for " & Row("ITEM_PROFILE").ToString.ToLower & " with Original Value " & PROF_TABLE.Rows(0)("Org Value").ToString, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            ...
                                            If xTemp_AssetID.Length > 0 Then
                                                If IsInsuaranceApplicable Then
                                                    If Base.IsInsuranceAudited() Then
                                                        ...
                                                        'Base.ShowMessagebox("Information...", "Sorry! Selected Entry contains insurance related assets which cannot be deleted after the completion of Insurance audit", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                    End If
                                                End If
                                        ...
                                        If d1.Rows.Count > 0 Then
                                            ...
                                            If Not IsDBNull(d1.Rows(0)("TR_TRF_CROSS_REF_ID")) Then
                                                If d1.Rows(0)("TR_TRF_CROSS_REF_ID").Length > 0 Then
                                                    ...
                                                    'Base.ShowMessagebox("Information...", "M a t c h e d   I n t e r n a l   T r a n s f e r   c a n n o t   b e   D e l e t e d . . . !" & multiUserMsg, Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                    If isRecChanged Then Grid_Display()
                                                    Exit Sub
                                                End If
                                            Else
                                ...
                                Case Common_Lib.Common.Voucher_Screen_Code.Fixed_Deposits
                                    ...
                                    Select Case xItemID
                                        Case "f6e4da62-821f-4961-9f93-f5177fca2a77"
                                            If IsDate(IsClosed) Then
                                                DevExpress.XtraEditors.XtraMessageBox.Show("F D   A l r e a d y   C l o s e d   /   R e n e w e d /  T r a n s f e r r e d . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                'Base.ShowMessagebox("Information...", "F D   A l r e a d y   C l o s e d   /   R e n e w e d . . . !", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Exit Sub
                                            ElseIf Has_Int_TDS > 0 Then
                                                DevExpress.XtraEditors.XtraMessageBox.Show("I n t e r e s t   /   T D S    a l r e a d y   e n t e r e d   a g a i n s t   F D . . . !" & vbNewLine & vbNewLine & "Please remove such transactions to edit/delete this FD.", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                'Base.ShowMessagebox("Information...", "I n t e r e s t   /   T D S    a l r e a d y   e n t e r e d   a g a i n s t   F D . . . !" & vbNewLine & vbNewLine & "Please remove such transactions to edit/delete this FD.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Exit Sub
                                            Else
                                                xfrm.iAction = Common_Lib.Common.FDAction.New_FD : xfrm.TitleX.Text = "FD Creation" : xfrm.CreatedFDID = xCross_Ref_Id
                                            End If
                                ...
                                Case Common_Lib.Common.Voucher_Screen_Code.Sale_Asset
                                    ...
                                    If DateDiff(DateInterval.Second, MaxEditOn, Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_EDIT_ON")) < 0 Then 'bug #5609 point2 fix
                                        ...
                                        If Adj_NextYear > 0 Then
                                            ...
                                            'Base.ShowMessagebox("Error!!", "Sorry! Some adjustments have already been made on this asset" & vbNewLine & vbNewLine & " Please delete those entries for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                            Exit Sub
                                        End If
                                    Else
                                        xfrm.Info_MaxEditedOn = MaxEditOn
                                ...
                                Case Common_Lib.Common.Voucher_Screen_Code.Journal
                                            ...
                                            Dim AssetTrfRecord As DataTable = Base._AssetTransfer_DBOps.GetAssetTransfers(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Nothing, xTemp_AssetID) 'Bug #5339 fix
                                                If AssetTrfRecord.Rows.Count > 0 Then
                                                    If AssetTrfRecord.Rows.Count > 0 Then
                                                        ...
                                                        'Base.ShowMessagebox("Error!!", "Sorry ! Selected Entry contains a asset which was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                        Exit Sub
                                                    End If
                                                End If
                                                'Gets any Txn where Current Asset is referenced, mostly in case of L&B
                                    ...
                                    For Each Row As DataRow In Base._Voucher_DBOps.GetRefRecordIDS(xTemp_MID).Rows
                                        If Row("ITEM_PROFILE") = "OTHER ASSETS" Or Row("ITEM_PROFILE") = "LAND & BUILDING" Then
                                            If Base.IsInsuranceAudited() Then
                                                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry! Selected Entry contains insurance related assets which cannot be deleted after the completion of Insurance audit", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                                'Base.ShowMessagebox("Information...", "Sorry! Selected Entry contains insurance related assets which cannot be deleted after the completion of Insurance audit", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                : Exit Sub
                                            End If
                                        End If
                                        If Row("ITEM_PROFILE") = "GOLD" Or Row("ITEM_PROFILE") = "SILVER" Or Row("ITEM_PROFILE") = "OTHER ASSETS" Or Row("ITEM_PROFILE") = "LIVESTOCK" Or Row("ITEM_PROFILE") = "LAND & BUILDING" Or Row("ITEM_VOUCHER_TYPE").ToString.ToUpper = "LAND & BUILDING" Or Row("ITEM_PROFILE") = "VEHICLES" Then
                                            If Not IsDBNull(Row("TR_TRF_CROSS_REF_ID")) Then
                                                RefId = Row("TR_TRF_CROSS_REF_ID")
                                                If Not RefId Is Nothing Then
                                                    If RefId.Length > 0 Then
                                                        ...
                                                        If DateDiff(DateInterval.Second, MaxEditOn, Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_EDIT_ON")) < 0 Then 'bug #5608 point2 fix
                                                            ...
                                                            If Adj_NextYear > 0 Then
                                                                ...
                                                                'Base.ShowMessagebox("Error!!", "Sorry! Selected Entry contains an asset against which adjustments have been made in current / next year" & vbNewLine & vbNewLine & " Please delete those entries for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                                Exit Sub
                                                            End If
                                                            'End If
                                                        Else
                                                ...
                                                End If
                                            End If
                                        ElseIf Row("ITEM_PROFILE") = "ADVANCES" Or Row("ITEM_PROFILE") = "OTHER LIABILITIES" Or Row("ITEM_PROFILE") = "OTHER DEPOSITS" Or Row("ITEM_PROFILE") = "WIP" Then 'Bug #5608 pt.3
                                            If Not IsDBNull(Row("TR_TRF_CROSS_REF_ID")) Then
                                                RefId = Row("TR_TRF_CROSS_REF_ID")
                                                If Not RefId Is Nothing Then
                                                    If RefId.Length > 0 Then
                                                    ...
                                                    If Base._next_Unaudited_YearID <> Nothing Then
                                                        If PROF_TABLE.Rows(0)("Next Year Closing Value") < 0 Then
                                                            ...
                                                            'Base.ShowMessagebox("Error!!", "Sorry !  Deletion of Selected Journal Entry creates a Negative Closing Balance in Next Year for " & Row("ITEM_PROFILE").ToString.ToLower & " with Original Value " & PROF_TABLE.Rows(0)("Org Value").ToString, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                            Exit Sub
                                                        End If
                                                    End If
                                                        ...
                                                        If PROF_TABLE.Rows(0)("Curr Value") < 0 Then
                                                            ...
                                                            'Base.ShowMessagebox("Error!!", "Sorry !  Deletion of Selected Journal Entry creates a Negative Closing Balance in Current Year for " & Row("ITEM_PROFILE").ToString.ToLower & " with Original Value " & PROF_TABLE.Rows(0)("Org Value").ToString, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                            Exit Sub
                                                        End If
                                                    End If
                                                End If
                                                ...
                                                For Each cRow As DataRow In Base._Voucher_DBOps.GetAssetItemID(xTemp_MID).Rows ' Get Actual Item IDs from Selected Transaction
                                                    ...
                                                    Select Case xTemp_AssetProfile ' Get Asset RecID from Particular Table 
                                                        ...
                                                        Case "LAND & BUILDING"
                                                            xTemp_AssetID = Base._Voucher_DBOps.GetAssetRecID(Common_Lib.RealTimeService.Tables.LAND_BUILDING_INFO, xTemp_MID)
                                                        Case "FIXED DEPOSITS"
                                                            xTemp_AssetID = Base._Voucher_DBOps.GetAssetRecID(Common_Lib.RealTimeService.Tables.FD_INFO, xTemp_MID)
                                                    End Select
                                                    If xTemp_AssetID.Length > 0 Then
                                                        Dim SaleRecord As DataTable = Base._Voucher_DBOps.GetSaleReferenceRecord(xTemp_AssetID)
                                                        If Not SaleRecord Is Nothing Then
                                            ...
                                            If Rec.Rows.Count > 0 Then
                                                ...
                                                If Not IsDBNull(Rec.Rows(0)("TR_TRF_CROSS_REF_ID")) Then
                                                    If Rec.Rows(0)("TR_TRF_CROSS_REF_ID").Length > 0 Then
                                                        ...
                                                        'Base.ShowMessagebox("Information...", "M a t c h e d   A s s e t   T r a n s f e r   c a n n o t   b e   D e l e t e d . . . !" & multiUserMsg, Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                        If isRecChanged Then Grid_Display()
                                                        Exit Sub
                                                    End If
                                                Else
                                ...
                                Case Common_Lib.Common.Voucher_Screen_Code.WIP_Finalization
                                    ...
                                    If xTemp_AssetID.Length > 0 Then
                                        ...
                                        If Not SaleRecord Is Nothing Then
                                            If SaleRecord.Rows.Count > 0 Then
                                                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! The asset created by current voucher was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                'Base.ShowMessagebox("Error!!", "Sorry ! The asset created by current voucher was sold on " & Convert.ToDateTime(SaleRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & SaleRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Exit Sub
                                            End If
                                        End If
                                        'Gets any Txn where Current Asset is referenced
                                        ...
                                        If Not ReferenceRecord Is Nothing Then
                                            If ReferenceRecord.Rows.Count > 0 Then
                                                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! The asset created by current voucher which was referred in a Dependent Entry Dated " & Convert.ToDateTime(ReferenceRecord.Rows(0)("TR_DATE")).ToLongDateString() & " of Rs." & ReferenceRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                'Base.ShowMessagebox("Error!!", "Sorry ! The asset created by current voucher which was referred in a Dependent Entry Dated " & Convert.ToDateTime(ReferenceRecord.Rows(0)("TR_DATE")).ToLongDateString() & " of Rs." & ReferenceRecord.Rows(0)("TR_AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Exit Sub
                                            End If
                                        End If
                                    Dim AssetTrfRecord As DataTable = Base._AssetTransfer_DBOps.GetAssetTransfers(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Nothing, xTemp_AssetID) 'Bug #5339 fix
                                        If AssetTrfRecord.Rows.Count > 0 Then
                                            If AssetTrfRecord.Rows.Count > 0 Then
                                                DevExpress.XtraEditors.XtraMessageBox.Show("Sorry ! The asset created by current voucher was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                'Base.ShowMessagebox("Error!!", "Sorry ! The asset created by current voucher was Transfered on " & Convert.ToDateTime(AssetTrfRecord.Rows(0)("TR_DATE")).ToLongDateString() & " for intitial payment of Rs." & AssetTrfRecord.Rows(0)("AMOUNT").ToString() & "." & vbNewLine & vbNewLine & " Please delete the record for deleting this Entry.", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                                Exit Sub
                                            End If
                                        End If
                                    End If

                                    Dim xfrm As New Frm_Voucher_Win_WIP_Finalization : xfrm.MainBase = Base : xfrm.Tag = Common_Lib.Common.Navigation_Mode._Delete : xfrm.xID.Text = xTemp_ID : xfrm.xMID.Text = xMaster_ID

                                    For Each Row As DataRow In Base._Voucher_DBOps.GetRefRecordIDS(xTemp_MID).Rows
                                        If Row("ITEM_PROFILE") = "OTHER ASSETS" Then
                                            If Not IsDBNull(Row("TR_TRF_CROSS_REF_ID")) Then
                                                xCross_Ref_Id = Row("TR_TRF_CROSS_REF_ID")
                                                Dim MaxEditOn As DateTime = Base._AssetDBOps.Get_Asset_Ref_MaxEditOn(xCross_Ref_Id)
                                                If DateDiff(DateInterval.Second, MaxEditOn, Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_EDIT_ON")) < 0 Then 'bug #5608 point2 fix
                                                    Dim SaleRecord As DataTable = Base._Voucher_DBOps.GetSaleReferenceRecord(xCross_Ref_Id)
                                                    If Not SaleRecord Is Nothing Then
            ...
            Case "VIEW"
                    If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.FocusedRowHandle) >= 0 Then
                        ...
                        If xTemp_ID = "OPENING BALANCE" Then
                            ...
                            'Base.ShowMessagebox("Information...", "Opening Balance cannot view from Voucher Entry...!" & vbNewLine & vbNewLine & "Note: Use Profile - Cash A/c. Information for CASH" & vbNewLine & Space(31) & "or Bank A/c. Information for BANK", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Exit Sub
                        End If
                        If xTemp_ID = "NOTE-BOOK" Then
                            Dim xFrm As New Frm_NoteBook_Info : xFrm.MainBase = Base : xFrm.Text = "Note-Book Entry (" & Me.Text & ")"
                        ...
                        If xTemp_ID.Length > 0 Then
                            ...
                            If Entry_Found = False Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("E n t r y   N o t   F o u n d  /  C h a n g e d   i n   b a c k g r o u n d  . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox("Information...", "E n t r y   N o t   F o u n d  /  C h a n g e d   i n   b a c k g r o u n d  . . . !", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Grid_Display() : Exit Sub
                            End If
                            ...
                            Select Case xVCode
                                ...
                                Case Common_Lib.Common.Voucher_Screen_Code.Asset_Transfer
                                    ...
                                    xfrm.ShowDialog(Me) : If xfrm.DialogResult = DialogResult.Retry Then Grid_Display() : If Not xfrm Is Nothing Then xfrm.Dispose()
                                Case Common_Lib.Common.Voucher_Screen_Code.WIP_Finalization
                                    Dim xfrm As New Frm_Voucher_Win_WIP_Finalization : xfrm.MainBase = Base : xfrm.Tag = Common_Lib.Common.Navigation_Mode._View : xfrm.xID.Text = xTemp_ID : xfrm.xMID.Text = xMaster_ID
                                    '-----------------------------+
                                    'Start : Edit date sent to Check if entry already changed 
                                    '-----------------------------+
                                    'xfrm.Info_LastEditedOn = Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_EDIT_ON")
            ...
            Case "MATCH TRANSFERS"
                    ...
                    If Not xVCode = Common_Lib.Common.Voucher_Screen_Code.Internal_Transfer Then
                        DevExpress.XtraEditors.XtraMessageBox.Show("P l e a s e   s e l e c t   a   I n t e r n a l   T r a n s f e r   V o u c h e r . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'Base.ShowMessagebox("Information...", "P l e a s e   s e l e c t   a   I n t e r n a l   T r a n s f e r   V o u c h e r . . . !", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                        : Exit Sub
                    End If
                    ...
                    If Status.Rows.Count > 0 Then
                        If Common_Lib.Common.Record_Status._Locked = Status.Rows(0)("REC_STATUS") Then
                            DevExpress.XtraEditors.XtraMessageBox.Show("L o c k e d   E n t r y   c a n n o t   b e   M a t c h e d . . . !" & vbNewLine & vbNewLine & "Note:" & vbNewLine & "-------" & vbNewLine & "Drop your Request to Madhuban for Unlock this Entry," & vbNewLine & "If you really want to do some action...!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                            'Base.ShowMessagebox("Information...", "L o c k e d   E n t r y   c a n n o t   b e   M a t c h e d . . . !" & vbNewLine & vbNewLine & "Note:" & vbNewLine & "-------" & vbNewLine & "Drop your Request to Madhuban for Unlock this Entry," & vbNewLine & "If you really want to do some action...!", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            : Exit Sub
                        End If
                    Else
                        DevExpress.XtraEditors.XtraMessageBox.Show("E n t r y   N o t   F o u n d . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'Base.ShowMessagebox("Information...", "E n t r y   N o t   F o u n d . . . !", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                        : Grid_Display() : Exit Sub
                    End If
                    ...
                    If xVCode = Common_Lib.Common.Voucher_Screen_Code.Internal_Transfer Then
                        ...
                        If Not IsDBNull(d1.Rows(0)("TR_TRF_CROSS_REF_ID")) Then
                            ...
                            If isRecChanged Then
                                ...
                                'Base.ShowMessagebox("Information...", "Record has already been matched in the background.", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                Grid_Display()
                                Exit Sub
                            End If
                        ...
                        Else
                            If isRecChanged Then
                                ...
                                'Base.ShowMessagebox("Information...", "Record has been unmatched in the background.", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                Grid_Display()
                                Exit Sub
                            End If
                        End If
            ...
            Case "UNMATCH TRANSFERS"
                ...
                If Not xVCode = Common_Lib.Common.Voucher_Screen_Code.Internal_Transfer Then
                        DevExpress.XtraEditors.XtraMessageBox.Show("P l e a s e   s e l e c t   a   I n t e r n a l   T r a n s f e r   V o u c h e r . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        'Base.ShowMessagebox("Information...", "P l e a s e   s e l e c t   a   I n t e r n a l   T r a n s f e r   V o u c h e r . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                        : Exit Sub
                    End If
                    ...
                    If IsDBNull(d1.Rows(0)("TR_TRF_CROSS_REF_ID")) Or d1.Rows(0)("TR_TRF_CROSS_REF_ID") Is Nothing Then
                        ...
                        'Base.ShowMessagebox("Information...", "S e l e c t e d   r e c o r d   i s   a l r e a d y   u n m a t c h e d  . . . !" & multiUserMsg, Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                        : Exit Sub
                        If isRecChanged Then Grid_Display() '#5518 fix
                        Exit Sub
                    Else
                        If isRecChanged Then
                            ...
                            'Base.ShowMessagebox("Information...", "Transfer Voucher matched in the background...!" & multiUserMsg, Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Grid_Display()
                            Exit Sub
                        End If
                    End If
                    ...
                    If Status.Rows.Count > 0 Then
                        If Common_Lib.Common.Record_Status._Locked = Status.Rows(0)("REC_STATUS") Then
                            ...
                            'Base.ShowMessagebox("Information..", "E n t r y   M a t c h e d   w i t h   t h i s   r e c o r d   i s   a l r e a d y   l o c k e d  . . . !" & vbNewLine & vbNewLine & "Note:" & vbNewLine & "-------" & vbNewLine & "Drop your Request to Madhuban for Unlock that Entry," & vbNewLine & "If you really want to do some action...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            : Exit Sub
                        End If
                    Else
                    ...
                    If xVCode = Common_Lib.Common.Voucher_Screen_Code.Internal_Transfer Then
                        If IsDBNull(d1.Rows(0)("TR_TRF_CROSS_REF_ID")) Then
                            ...
                            'Base.ShowMessagebox("Information...", "T r a n s f e r   V o u c h e r   a l r e a d y   u n m a t c h e d . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Exit Sub
                        End If
                    'Unmatch here
                    If Base._Internal_Tf_Voucher_DBOps.UnMatchTransfers(xTemp_ID, d1.Rows(0)("TR_TRF_CROSS_REF_ID"), xTr_Date) Then
                        ...
                        'Base.ShowMessagebox("Information...", "T r a n s f e r   E n t r y   u n m a t c h e d   s u c c e s s f u l l y . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                        Grid_Display()
                    Else
                        DevExpress.XtraEditors.XtraMessageBox.Show("S o r r y !   T r a n s f e r   E n t r y   C o u l d   n o t   b e   u n m a t c h e d   s u c c e s s f u l l y . . . !", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                            'Base.ShowMessagebox("Information...", "S o r r y !   T r a n s f e r   E n t r y   C o u l d   n o t   b e   u n m a t c h e d   s u c c e s s f u l l y . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                        End If
            ...
            Case "VOUCHER"
                    ...
                    Else
                        ...
                        'Base.ShowMessagebox("Voucher Print", "C o m i n g   S o o n . . . !", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
            ...
            Case "LOCKED_ALL"
                    ...
                    If Me.BandedGridView1.RowCount > 0 And Base.CheckActionRights(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Common_Lib.Common.ClientAction.Lock_Unlock) Then
                        ...
                        If NotLocked > 0 Then
                            ...
                            'Base.ShowMessagebox("Locked...", NotLocked & " R e c o r d s   n o t  l o c k e d  s u c c e s s f u l l y . . . !" & vbNewLine & vbNewLine & "Incomplete Records, Records with open Queries, Notebook Expenses and Opening Balances are skipped.", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Grid_Display()
                            Exit Sub
                        Else
                            ...
                            'Base.ShowMessagebox("Locked...", "A l l   R e c o r d s   L o c k e d   S u c c e s s f u l l y . . . !" & vbNewLine & vbNewLine & "Notebook Expenses and Opening Balances are skipped.", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Grid_Display()
                            Exit Sub
                        End If
                    End If
            Case "LOCKED"
                    If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.SelectedRowsCount) > 0 And Base.CheckActionRights(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Common_Lib.Common.ClientAction.Lock_Unlock) Then
                        ...
                        For Each CurrRowHandle As Integer In Me.BandedGridView1.GetSelectedRows
                            ...
                            If xTemp_ID.Length < 36 Then
                                If xTemp_ID.ToString.ToLower = "opening balance" Then
                                    DevExpress.XtraEditors.XtraMessageBox.Show("O p e n i n g   B a l a n c e s   c a n   b e   u n l o c k e d   i n   p r o f i l e   s c r e e n s   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect opening balance Entries ...!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                    'Base.ShowMessagebox("Information...", "O p e n i n g   B a l a n c e s   c a n   b e   u n l o c k e d   i n   p r o f i l e   s c r e e n s   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect opening balance Entries ...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    : Exit Sub
                                End If
                                If xTemp_ID.ToString.ToLower = "note-book" Then
                                    DevExpress.XtraEditors.XtraMessageBox.Show("N o t e b o o k   e n t r i e s   c a n   b e   u n l o c k e d   i n   N o t e b o o k   s c r e e n   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect notebook Entries ...!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                    'Base.ShowMessagebox("Information...", "N o t e b o o k   e n t r i e s   c a n   b e   u n l o c k e d   i n   N o t e b o o k   s c r e e n   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect notebook Entries ...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    : Exit Sub
                                End If
                            End If
                            ...
                            Dim Msg As String = ""
                            Dim AllowUser As Boolean = False
                            Dim Status As DataTable = Base._Voucher_DBOps.GetStatus_TrCode(Me.BandedGridView1.GetRowCellValue(CurrRowHandle, "iREC_ID").ToString(), xTemp_ID)
                            If Status Is Nothing Then
                                DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                'Base.ShowMessagebox("Error!!", Common_Lib.Messages.SomeError, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                Exit Sub
                            ...
                            If MaxValue = Common_Lib.Common.Record_Status._Locked Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("A l r e a d y   L o c k e d   E n t r i e s   c a n n o t   b e   R e - L o c k e d . . . !" & vbNewLine & vbNewLine & "Please unselect already locked Entries ...!", Msg, MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox(Msg, "A l r e a d y   L o c k e d   E n t r i e s   c a n n o t   b e   R e - L o c k e d . . . !" & vbNewLine & vbNewLine & "Please unselect already locked Entries ...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Exit Sub
                            End If
                            If MaxValue = Common_Lib.Common.Record_Status._Incomplete Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("I n c o m p l e t e   E n t r i e s   c a n n o t   b e   L o c k e d . . . !" & vbNewLine & vbNewLine & "Please unselect incomplete Entries or ask Center to Complete it...!", Msg, MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox(Msg, "I n c o m p l e t e   E n t r i e s   c a n n o t   b e   L o c k e d . . . !" & vbNewLine & vbNewLine & "Please unselect incomplete Entries or ask Center to Complete it...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Exit Sub
                            End If
                            If Not xRemarks Is Nothing And Not IsDBNull(xRemarks) Then
                                If MaxValue > 0 Then
                                    DevExpress.XtraEditors.XtraMessageBox.Show("E n t r i e s   w i t h   p e n d i n g   q u e r i e s   c a n ' t   b e   L o c k e d. . . !" & vbNewLine & vbNewLine & "Please unselect such Entries...!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                    'Base.ShowMessagebox("Information...", "E n t r i e s   w i t h   p e n d i n g   q u e r i e s   c a n ' t   b e   L o c k e d. . . !" & vbNewLine & vbNewLine & "Please unselect such Entries...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                    : Exit Sub
                                End If
                            End If
                        ...
                        If Ctr > 0 Then
                            ...
                            'Base.ShowMessagebox("Locked...", Common_Lib.Messages.LockedSuccess(Ctr), Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Grid_Display()
                            Exit Sub
                        End If
                    End If
            Case "UNLOCKED"
                    If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.SelectedRowsCount) > 0 And Base.CheckActionRights(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Common_Lib.Common.ClientAction.Lock_Unlock) Then
                        ...
                        For Each CurrRowHandle As Integer In Me.BandedGridView1.GetSelectedRows
                            ...
                            End If
                            If MaxValue = Common_Lib.Common.Record_Status._Completed Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("A l r e a d y   U n l o c k e d   E n t r i e s   c a n n o t   b e   R e - U n l o c k e d . . . !" & vbNewLine & vbNewLine & "Please unselect already unlocked Entries ...!", Msg, MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox(Msg, "A l r e a d y   U n l o c k e d   E n t r i e s   c a n n o t   b e   R e - U n l o c k e d . . . !" & vbNewLine & vbNewLine & "Please unselect already unlocked Entries ...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Exit Sub
                            End If
                            If MaxValue = Common_Lib.Common.Record_Status._Incomplete Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("I n c o m p l e t e   E n t r i e s   c a n n o t   b e   U n l o c k e d . . . !" & vbNewLine & vbNewLine & "Please unselect incomplete Entries or ask Center to Complete it...!", Msg, MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox(Msg, "I n c o m p l e t e   E n t r i e s   c a n n o t   b e   U n l o c k e d . . . !" & vbNewLine & vbNewLine & "Please unselect incomplete Entries or ask Center to Complete it...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Exit Sub
                            End If
                            'If Base._open_User_Type.ToUpper = Common_Lib.Common.ClientUserType.Auditor.ToUpper Then
                            '    If Not Me.BandedGridView1.GetRowCellValue(CurrRowHandle, "iREC_STATUS_BY").ToString().ToUpper.Equals(Base._open_User_ID.ToUpper) Then
                        ...
                        If Ctr > 0 Then
                            ...
                            'Base.ShowMessagebox("Locked...", Common_Lib.Messages.UnlockedSuccess(Ctr), Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Grid_Display()
                            Exit Sub
                        End If
                    End If
            Case "REMARKS"
                    If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.FocusedRowHandle) >= 0 And Base.CheckActionRights(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Common_Lib.Common.ClientAction.View_Remarks) Then
                        ...
                        If xTemp_ID.Length < 36 Then
                            If xTemp_ID.ToString.ToLower = "opening balance" Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("R e m a r k s   f o r   O p e n i n g   B a l a n c e s   c a n   b e   v i e w e d   i n   p r o f i l e   s c r e e n s   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect opening balance Entries ...!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox("Information...", "R e m a r k s   f o r   O p e n i n g   B a l a n c e s   c a n   b e   v i e w e d   i n   p r o f i l e   s c r e e n s   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect opening balance Entries ...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Exit Sub
                            End If
                            If xTemp_ID.ToString.ToLower = "note-book" Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("R e m a r k s   f o r   N o t e b o o k   e n t r i e s   c a n   b e   v i e w e d   i n   N o t e b o o k   s c r e e n   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect notebook Entries ...!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox("Information...", "R e m a r k s   f o r   N o t e b o o k   e n t r i e s   c a n   b e   v i e w e d   i n   N o t e b o o k   s c r e e n   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect notebook Entries ...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Exit Sub
                            End If
                        End If
                        Dim xStatus As String = Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iACTION_STATUS").ToString()
            ...
            Case "ADD REMARKS"
                    If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.FocusedRowHandle) >= 0 And Base.CheckActionRights(Common_Lib.RealTimeService.ClientScreen.Accounts_Vouchers, Common_Lib.Common.ClientAction.Manage_Remarks) Then
                        ...
                        If xTemp_ID.Length < 36 Then
                            If xTemp_ID.ToString.ToLower = "opening balance" Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("R e m a r k s   f o r   O p e n i n g   B a l a n c e s   c a n   b e   a d d e d   i n   p r o f i l e   s c r e e n s   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect opening balance Entries ...!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox("Information...", "R e m a r k s   f o r   O p e n i n g   B a l a n c e s   c a n   b e   a d d e d   i n   p r o f i l e   s c r e e n s   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect opening balance Entries ...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Exit Sub
                            End If
                            If xTemp_ID.ToString.ToLower = "note-book" Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("R e m a r k s   f o r   N o t e b o o k   e n t r i e s   c a n   b e   a d d e d   i n   N o t e b o o k   s c r e e n   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect notebook Entries ...!", "Information...", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                'Base.ShowMessagebox("Information...", "R e m a r k s   f o r   N o t e b o o k   e n t r i e s   c a n   b e   a d d e d   i n   N o t e b o o k   s c r e e n   o n l y . . . !" & vbNewLine & vbNewLine & "Please unselect notebook Entries ...!", Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                : Exit Sub
                            End If
                        End If
                        xID = Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_ID").ToString()
                        ...
                        Else
                            ...
                            'Base.ShowMessagebox("Information...", "Q u e r i e s   c a n n o t   b e   a d d e d   t o   F r e e z e d   E n t r y . . . !", Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Exit Sub
                        End If
                    End If
            Case "COMPLETED1"
                If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.FocusedRowHandle) >= 0 Then
                    ...
                    If xTemp_ID.Length > 0 Then
                        ...
                        Dim xEntry As String = "Name: " & xTemp_1 & vbNewLine &
                                                "Make: " & xTemp_2
                        ...
                        If DialogResult.Yes = xPromptWindow.ShowDialog("Confirmation...", "<u>Sure you want to<color=red> Completed</color> this Entry...?</u>" & vbNewLine & vbNewLine & "<size=12>" & xEntry & "</size>", Common_Lib.Prompt_Window.ButtonType._Question, Common_Lib.Prompt_Window.WindowSize._499x180, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue) Then
                            ...
                            If Base._open_User_ID.Trim.ToUpper.ToString <> xEdit_By.Trim.ToUpper.ToString Then
                                DevExpress.XtraEditors.XtraMessageBox.Show("I n c o r r e c t   U s e r . . . !" & vbNewLine &
                                                                            "=================" & vbNewLine & vbNewLine &
                                                                            "Following Entry Control By " & xEdit_By.ToString & " User...!" & vbNewLine & vbNewLine &
                                                                            xEntry, "Cannot Completed.....", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                'Base.ShowMessagebox("Cannot Completed.....", "I n c o r r e c t   U s e r . . . !" & vbNewLine & "=================" & vbNewLine & vbNewLine & "Following Entry Control By " & xEdit_By.ToString & " User...!" & vbNewLine & vbNewLine & xEntry, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._599x220, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                Exit Sub
                            End If
                            If Base._Voucher_DBOps.MarkAsComplete(xTemp_ID) Then
                                ...
                                'Base.ShowMessagebox("Action...", Common_Lib.Messages.UpdateSuccess, Common_Lib.Prompt_Window.ButtonType._Information, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                            Else
                                DevExpress.XtraEditors.XtraMessageBox.Show(Common_Lib.Messages.SomeError, "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                'Base.ShowMessagebox("Error!!", Common_Lib.Messages.SomeError, Common_Lib.Prompt_Window.ButtonType._Exclamation, Common_Lib.Prompt_Window.WindowSize._399x140, Common_Lib.Prompt_Window.FocusButton._Button1, Color.AliceBlue, "OK", "OK")
                                Exit Sub
            ...
            Case "ADD-ATTACHMENT"
                ...
                If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.FocusedRowHandle) >= 0 Then
                    Dim xTemp_ID As String = Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iTR_M_ID").ToString()
                    If xTemp_ID.Length = 0 Then xTemp_ID = Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_ID").ToString()
                    Add_Attachment(Me.Txt_TitleX.Text, [Enum].GetName(GetType(Common_Lib.Common.Voucher_Screen_Code), xVCode), Me, xTemp_ID)
                End If
            Case "MANAGE-ATTACHMENT"
                ...
                If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.FocusedRowHandle) >= 0 Then
                    Dim xTemp_ID As String = Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iTR_M_ID").ToString()
                    If xTemp_ID.Length = 0 Then xTemp_ID = Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_ID").ToString()
                    Manage_Attachment(Me.Txt_TitleX.Text, [Enum].GetName(GetType(Common_Lib.Common.Voucher_Screen_Code), xVCode), Me, xTemp_ID)
                End If
            Case "LINK-ATTACHMENT"
                ...
                If Me.BandedGridView1.RowCount > 0 And Val(Me.BandedGridView1.FocusedRowHandle) >= 0 Then
                    Dim xTemp_ID As String = Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iTR_M_ID").ToString()
                    If xTemp_ID.Length = 0 Then xTemp_ID = Me.BandedGridView1.GetRowCellValue(Me.BandedGridView1.FocusedRowHandle, "iREC_ID").ToString()
                    Link_Attachment(Me.Txt_TitleX.Text, [Enum].GetName(GetType(Common_Lib.Common.Voucher_Screen_Code), xVCode), Me, xTemp_ID)
                End If
            Case "REFRESH"
                    Grid_Display()
            Case "PRINT-LIST"
...
#End Region
    ...
    'Private Sub gridView1_CustomDrawCell(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs) Handles BandedGridView1.CustomDrawCell
    '    If e.RowHandle = 2 Then
    '        If e.Column.FieldName = "iTR_CODE" Then
    '            If e.CellValue = "3" Then
    '                e.Handled = True
    '                'Dim wc As New WebClient()
    '                'Dim bytes As Byte() = wc.DownloadData("https://www.devexpress.com/Support/Center/Attachment/GetAvatar/1b4722bd-c8c4-4f68-97ad-9668a4f0a2d5?type=Medium")
    '                'Dim ms As New MemoryStream(bytes)
    '                'Dim img As System.Drawing.Image = System.Drawing.Image.FromStream(ms)

    '                Dim img As System.Drawing.Image = Image.FromStream(Me.GetType().Assembly.GetManifestResourceStream("attach.gif"))
    '                Dim pos As Point = CalcPosition(e, img)
    ...
    'Private Function CalcPosition(ByVal e As RowCellCustomDrawEventArgs, ByVal img As Image) As Point
    '    Dim p As New Point()
    ...
    '        If e.IsGetData And Me.BandedGridView1.GetRowCellValue(e.ListSourceRowIndex, "iTR_CODE").ToString = "3" Then
    '            e.Value = System.Drawing.Image.FromFile("attach.gif")
    '        End If
    '    End If
    'End Sub
