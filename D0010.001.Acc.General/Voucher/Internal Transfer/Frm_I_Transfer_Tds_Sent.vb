...
Public Class Frm_I_Transfer_Tds_Sent
...
#Region "Start--> Form Events"
    ...
    Private Sub Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        xPleaseWait.Show("TDS Deduction Entries for TDS being sent to HQ" & vbNewLine & vbNewLine & "L o a d i n g . . . !")
        Base = MainBase
        Set_Default()
        Me.Focus()
    End Sub
...
#Region "Start--> Button Events"
    ...
    Private Sub BUT_ACCEPT_Click(sender As Object, e As EventArgs) Handles BUT_ACCEPT.Click
        ...
        '    DevExpress.XtraEditors.XtraMessageBox.Show("Please enter 'TDS sent' amount equal to amount mentioned in voucher(Rs." & lblMentionedInvoucher.Text & "), against TDS dedcuted entries, in highlighted column", "Referred Record Already Changed!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        '    Exit Sub
        'End If

        Dim DataRowCount As Integer = GridView1.DataRowCount
        For I = 0 To DataRowCount - 1
            If Val(GridView1.GetRowCellValue(I, "TDS_Send").ToString()) > 0 Then
                Dim inParam As New Out_TDS()
                inParam.TDS_Ded = Val(GridView1.GetRowCellValue(I, "TDS_Send").ToString())
...
#Region "Start--> Grid Events"
    ...
    Private Sub GridView1_ValidatingEditor(sender As Object, e As Controls.BaseContainerValidateEditorEventArgs) Handles GridView1.ValidatingEditor
        ...
        If View.FocusedColumn.FieldName = "TDS_Send" Then
...
#Region "Start--> Procedures"
    Private Sub SetBalances()
        ...
        Dim I As Integer
        For I = 0 To DataRowCount - 1
            lblOnScreenSelection.Text = CStr(Val(lblOnScreenSelection.Text) + Val(GridView1.GetRowCellValue(I, "TDS_Send").ToString()))
        Next
    ...
    Public Sub Grid_Display()
        xPleaseWait.Show("TDS Deduction Entries for TDS being sent to HQ" & vbNewLine & vbNewLine & "L o a d i n g . . . !")
        RowFlag1 = False
        Dim p1 As DataTable = Base._Payment_DBOps.GetTDS_Deducted_Not_Sent(xMID)
        ...
        Else
            Try
                Me.GridView1.FocusedColumn = Me.GridView1.Columns("TDS_Send")
