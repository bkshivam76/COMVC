...
Public Class Frm_Voucher_Win_Gen_Pay_Tds_Ded
...
#Region "Start--> Form Events"
    ...
    Private Sub Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        xPleaseWait.Show("TDS Deduction Entries for TDS being paid to Govt." & vbNewLine & vbNewLine & "L o a d i n g . . . !")
        Base = MainBase
        Set_Default()
        Me.Focus()
    End Sub
...
#Region "Start--> Button Events"
    ...
    End Sub
    Private Sub ButtonGotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles BUT_ACCEPT.GotFocus, BTN_BACK.GotFocus
        Dim btn As SimpleButton
        btn = CType(sender, SimpleButton)
        btn.Font = New Font("Tahoma", 8, FontStyle.Bold)
    End Sub
    Private Sub ButtonLostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles BUT_ACCEPT.LostFocus, BTN_BACK.LostFocus
        Dim btn As SimpleButton
        btn = CType(sender, SimpleButton)
    ...
    End Sub
    Private Sub ButtonKeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles BUT_ACCEPT.KeyDown, BTN_BACK.KeyDown
        If e.KeyCode = Keys.PageUp Then SendKeys.Send("+{TAB}")
    End Sub
    Private Sub BUT_ACCEPT_Click(sender As Object, e As EventArgs) Handles BUT_ACCEPT.Click
        If Val(Me.lblNetBalance.Text) <> 0 Then
            DevExpress.XtraEditors.XtraMessageBox.Show("Please enter 'TDS paid to Govt.' amount equal to amount mentioned in voucher(Rs." & lblMentionedInvoucher.Text & "), against TDS dedcuted entries, in highlighted column", "Referred Record Already Changed!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        End If
...
#Region "Start--> Grid Events"
    ...
    Private Sub GridView1_FocusedRowChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles GridView1.FocusedRowChanged
        Try
            ...
            Else
                Me.GridView1.Tag = -1
            End If
            If GridView1.FocusedColumn.Caption = "TDS Being Paid" Then
                SendKeys.Send("{F2}")
            End If
    ...
    Private Sub GridView1_FocusedColumnChanged(sender As Object, e As FocusedColumnChangedEventArgs) Handles GridView1.FocusedColumnChanged
        If e.FocusedColumn.Caption = "TDS Being Paid" Then
            SendKeys.Send("{F2}")
        End If
    End Sub
    ...
    Private Sub GridView1_ValidatingEditor(sender As Object, e As Controls.BaseContainerValidateEditorEventArgs) Handles GridView1.ValidatingEditor
        ...
        If View.FocusedColumn.FieldName = "TDS_Paid" Then
            If Not e.Value Is Nothing Then
                ...
                '    If TDS_being_sent > Val(Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "TDS_Deducted")) - Val(Me.GridView1.GetRowCellValue(Me.GridView1.FocusedRowHandle, "TDS_Already_Sent")) Then
                '        e.Valid = False
                ...
                If TDS_being_sent < 0 Then
                    e.Valid = False
                    e.ErrorText = "Please enter Valid TDS Paid amount!!"
                End If
            End If
        End If
    End Sub
...
#Region "Start--> Procedures"
    ...
    Public Sub Grid_Display()
        xPleaseWait.Show("TDS Deduction Entries for TDS being Paid to HQ" & vbNewLine & vbNewLine & "L o a d i n g . . . !")
        RowFlag1 = False
        Dim p1 As DataTable = Base._Payment_DBOps.GetTDS_Deducted_Not_Paid(xMID)
    ...
    Public Sub DataNavigation(ByVal Action As String)
        Select Case Action
            ...
            Case "PRINT-LIST"
                If Me.GridView1.RowCount > 0 Then
                    Base.Show_ListPreview(GridControl1, Me.Text, Me, True, Printing.PaperKind.A4, "Pending TDS Paid to Govt.", "UID: " & Base._open_UID_No, "Year: " & Base._open_Year_Name, True)
                End If
                Me.GridView1.Focus()
            Case "CLOSE"
                Me.DialogResult = Windows.Forms.DialogResult.Retry
