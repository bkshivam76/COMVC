...
namespace WhatsappBusiness.CloudApi.Interfaces
{
    public interface IWhatsAppBusinessClient
    {
        ...
        /// <returns></returns>
        Task<WhatsAppResponse> SendDynamicURLButtonMessage(DynamicURLTemplateMessageRequest dynamicURLButtonMessage, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<WhatsAppResponse> SendDynamicURLButtonMessageAsync(DynamicURLTemplateMessageRequest dynamicURLButtonMessage, CancellationToken cancellationToken = default);
        #endregion
