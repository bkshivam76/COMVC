...
namespace WhatsappBusiness.CloudApi
{
    public static class WhatsAppBusinessRequestEndpoint
    {
        ...
        /// </summary>
        // public static string SendMessage { get; private set; } = V14BaseAddress+"{{Phone-Number-ID}}/messages";
        public static string SendMessage { get; private set; } = V14BaseAddress + "{{Phone-Number-ID}}/messages";
        /// <summary>
        /// Endpoint to send WhatsApp Messages
        /// </summary>
        //public static string MarkMessageAsRead { get; private set; } = "{{Phone-Number-ID}}/messages";
        public static string MarkMessageAsRead { get; private set; } = V14BaseAddress+"{{Phone-Number-ID}}/messages";
        /// <summary>
